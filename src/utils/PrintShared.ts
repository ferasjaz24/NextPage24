export const sharedPrintHeader = `
  <div style="width: 100%; text-align: center; margin-bottom: 24px; user-select: none;">
    <img src="https://i.postimg.cc/BZ1y7kQW/HEEDER-NEXT-PAGE-4x.png" referrerpolicy="no-referrer" alt="Header" style="width: 100%; max-height: 120px; object-fit: contain;" />
  </div>
`;

export const sharedPrintFooter = `
  <div style="width: 100%; text-align: center; margin-top: auto; padding-top: 16px; user-select: none;">
    <img src="https://i.postimg.cc/pXfSRjFk/tdyyl-NEXTPAGE-4x.png" referrerpolicy="no-referrer" alt="Footer" style="width: 100%; max-height: 120px; object-fit: contain;" />
  </div>
`;
