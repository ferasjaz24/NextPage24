      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 border-b border-slate-100 pb-4">
        <div>
          <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
            <ShoppingBag className="w-6 h-6 text-[#1C5B6B]" />
        ...
        <div className="flex items-center gap-2 self-start lg:self-center">
          ...
          {canAdd && (
            <button
              ...
              className="flex items-center gap-2 bg-[#1C5B6B] hover:bg-[#1C5B6B]/90 text-white font-extrabold px-4 py-2.5 rounded-xl transition duration-150 text-xs shadow-md shadow-[#1C5B6B]/10"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 bg-slate-50/50 p-4 rounded-xl border border-slate-100">
        ...
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full text-xs font-semibold pl-9 pr-3 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 focus:border-[#1C5B6B] text-left font-mono bg-white"
            />
        ...
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full text-xs font-semibold pl-9 pr-3 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 focus:border-[#1C5B6B] bg-white"
            />
        ...
        <div>
          ...
          <select
            ...
            className="w-full text-xs font-semibold px-3 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 focus:border-[#1C5B6B] bg-white"
          >
      ...
      <div className="border border-slate-150 rounded-xl overflow-hidden bg-white">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-16 space-y-2">
            <RefreshCw className="w-8 h-8 text-[#1C5B6B] animate-spin" />
                    ...
                    <td className="py-4 px-4 text-center whitespace-nowrap">
                      <div className="flex items-center justify-center gap-2" onClick={(e) => e.stopPropagation()}>
                        <button
                          ...
                          className="p-1.5 text-slate-500 hover:text-[#1C5B6B] hover:bg-slate-100 rounded-lg transition"
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-100">
                    ...
                    <div className="text-center bg-blue-50/50 rounded-lg p-1 border border-blue-100/50">
                      ...
                      <span className="font-black text-[#1C5B6B] text-sm font-sans">SAR {Number(selectedRequest.totalAmount || 0).toLocaleString("en-US", { minimumFractionDigits: 2 })}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs overflow-y-auto p-4 z-50 flex justify-center items-start sm:items-center">
          <div className="my-8 sm:my-auto bg-white rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl border border-slate-100 animate-in fade-in zoom-in-95 duration-150">
            ...
            {/* Modal Header */}
            <div className="bg-[#1C5B6B] text-white p-4 flex items-center justify-between">
              <h3 className="font-black text-sm">
            ...
            <form onSubmit={handleCreateRequest} className="p-6 space-y-4 text-right overflow-y-auto max-h-[85vh]">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full text-xs font-bold px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 focus:border-[#1C5B6B]"
                />
              </div>
              ...
              <div className="bg-slate-50/60 p-4 rounded-xl border border-slate-200 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2 bg-slate-100 p-1 rounded-lg">
                    <button
                      ...
                      className={`py-1.5 px-3 rounded text-[11px] font-black transition ${
                        formType === "materials" 
                          ? "bg-white text-[#1C5B6B] shadow-xs font-black" 
                ...
                {formType === "materials" ? (
                  <div>
                    ...
                    <select
                      ...
                      className="w-full text-xs font-bold px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 focus:border-[#1C5B6B] bg-white"
                    >
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs font-bold px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 focus:border-[#1C5B6B] text-left font-sans"
                    />
                  </div>
                ...
                <div className="flex justify-end pt-1">
                  <button
                    ...
                    className="flex items-center gap-1 bg-[#1C5B6B]/10 hover:bg-[#1C5B6B]/20 text-[#1C5B6B] font-bold px-3 py-2 rounded-lg transition duration-150 text-xs"
                  >
                    <Plus className="w-4 h-4" />
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full text-xs font-semibold px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 focus:border-[#1C5B6B] text-right"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs font-semibold px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 focus:border-[#1C5B6B]"
                />
              </div>
              ...
              <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 flex justify-between items-center text-xs">
                ...
                <span className="font-sans font-black text-[#1C5B6B] text-sm">
                  SAR {
                    (formItems.length > 0 
              ...
              <div className="flex gap-2 justify-end pt-3 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-[#1C5B6B] hover:bg-[#1C5B6B]/90 text-white rounded-xl text-xs font-extrabold transition shadow-md shadow-[#1C5B6B]/10"
                >
            ...
            <div className="p-5 space-y-4 text-right">
              ...
              <div className="flex gap-2 justify-end pt-3">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#1C5B6B] hover:bg-[#1C5B6B]/90 text-white rounded-xl text-xs font-extrabold flex items-center gap-1.5 transition"
                >
