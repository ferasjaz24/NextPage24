  ...
  const handleOpenPrintTab = (inv: SupplierInvoice) => {
    ...
    const itemsRowsHtml = (inv.items || []).map((it, idx) => `
      <tr>
        ...
        <td style="text-align: left; font-family: monospace; font-weight: 900; color: #1C5B6B;">${Number(it.total || 0).toLocaleString("en-US", { minimumFractionDigits: 2 })}</td>
      </tr>
    `).join("");
      ...
      <body>
        <div class="invoice-container ${(inv.items || []).length <= 3 ? "compact-invoice" : ""}">
          ...
          <div class="signatures">
            ...
            <div>
              <div class="sig-line" style="color: #1C5B6B; border-top-color: #1C5B6B;">الاعتماد المالي المعتمد / Financial Approval</div>
    ...
    <div id="supplier-invoices-tab-container" className="space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 max-w-md w-full shadow-2xl border border-slate-100 animate-in fade-in zoom-in duration-250">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-5 py-2 text-xs font-black text-white bg-[#1C5B6B] hover:bg-opacity-90 rounded-xl shadow-md transition"
              >
      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="bg-[#1C5B6B] hover:bg-opacity-90 text-white text-xs font-black px-5 py-3 rounded-xl flex items-center justify-center gap-2 transition shadow-md"
        >
              ...
              <tbody>
                {filteredInvoices.map((inv) => (
                  <tr key={inv.id} className="border-b border-slate-100 hover:bg-slate-50/80 transition duration-150">
                    <td className="p-4 font-mono font-bold text-[#1C5B6B]">{inv.invoiceNo}</td>
            ...
            <form onSubmit={handleSaveInvoice} className="space-y-5 text-right">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between px-4 py-2.5 text-xs border border-slate-200 rounded-xl bg-white text-slate-700 outline-none hover:border-slate-300 focus:ring-2 focus:ring-[#1C5B6B] transition text-right"
                  >
                              ...
                              return (
                                <button
                                  ...
                                  className={`w-full text-right px-4 py-2.5 hover:bg-slate-50 flex items-center justify-between font-semibold transition ${
                                    isSelected ? "bg-blue-50/50 text-[#1C5B6B]" : "text-slate-700"
                                  }`}
                                >
                                  <span>{sup.name}</span>
                                  {isSelected && <span className="text-[#1C5B6B] text-xs">✓</span>}
                                </button>
                              );
                            })}
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 text-xs border border-slate-200 rounded-xl bg-white outline-none focus:ring-2 focus:ring-[#1C5B6B] disabled:bg-slate-50 disabled:text-slate-400 font-semibold"
                  >
                    <option value="">
                      {!selectedSupplierForInvoice
                        ? lang === "ar"
              ...
              <div className="border border-slate-100 rounded-2xl overflow-hidden mt-4">
                <div className="bg-slate-50 p-3 flex justify-between items-center border-b border-slate-100">
                  ...
                  <button
                    ...
                    className="text-xs font-black text-white bg-[#1C5B6B] hover:bg-opacity-90 px-3 py-1.5 rounded-lg transition"
                  >
                      ...
                      <div className="md:col-span-2 flex items-center justify-center h-10">
                        <label className="flex items-center gap-2 text-xs font-semibold cursor-pointer select-none">
                          <input
                            ...
                            className="w-4 h-4 text-[#1C5B6B] border-slate-300 rounded"
                          />
              ...
              <div className="flex justify-end mt-4">
                <div className="bg-slate-50 p-4 rounded-2xl w-full max-w-sm space-y-2 border border-slate-100 font-semibold">
                  ...
                  <div className="flex justify-between text-sm font-black text-[#1C5B6B]">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 text-xs font-black text-white bg-[#1C5B6B] hover:bg-opacity-90 rounded-xl shadow-md transition"
                >
