    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex items-center justify-between cursor-pointer hover:shadow-md transition" onClick={() => setFilterStatus("all")}>
          <div className="space-y-1.5 text-right">
            ...
            <div className="text-2xl font-black text-[#1C5B6B]">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white p-4 rounded-2xl shadow-sm border border-slate-200">
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          <div className="relative w-full md:w-64">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]"
            />
          </div>
          <select
            value={filterStatus}
            onChange={(e) => setFilterStatus(e.target.value)}
            className="w-full md:w-48 px-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]"
          >
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-2 bg-[#1C5B6B] text-white rounded-xl font-bold hover:bg-[#005a96] transition-all duration-150 active:scale-95 shadow-sm w-full md:w-auto justify-center"
        >
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <input type="date" lang="en" value={formData.date} onChange={e => setFormData({...formData, date: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">مصدر الإيراد <span className="text-rose-500">*</span></label>
                  <select value={formData.source} onChange={e => setFormData({...formData, source: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="text" list="clients-list" placeholder="اسم العميل..." value={formData.client} onChange={e => setFormData({...formData, client: e.target.value, quoteNumber: "", projectName: ""})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
                ...
                <div>
                  ...
                  }} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
                ...
                <div>
                  ...
                  <input type="text" placeholder="اختياري..." value={formData.invoiceNumber} onChange={e => setFormData({...formData, invoiceNumber: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="text" placeholder="اختياري..." value={formData.projectName} onChange={e => setFormData({...formData, projectName: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">المبلغ <span className="text-rose-500">*</span></label>
                  <input type="number" lang="en" placeholder="0.00" value={formData.amount} onChange={e => setFormData({...formData, amount: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none font-bold text-emerald-600 text-lg" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">طريقة الدفع <span className="text-rose-500">*</span></label>
                  <select value={formData.paymentMethod} onChange={e => setFormData({...formData, paymentMethod: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {formData.paymentMethod === "نقدي" ? (
                  <div>
                    ...
                    <select value={formData.cashBoxId || ""} onChange={e => setFormData({...formData, cashBoxId: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none">
                  ...
                  <div>
                    ...
                    <select value={formData.bankAccountId || ""} onChange={e => setFormData({...formData, bankAccountId: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" placeholder="رقم العملية أو المرجع..." value={formData.reference} onChange={e => setFormData({...formData, reference: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex gap-2 items-center">
                      <label className="flex-1 flex items-center justify-center gap-2 p-3 border-2 border-dashed border-slate-300 rounded-xl hover:border-[#1C5B6B] hover:bg-slate-50 cursor-pointer transition">
              ...
              <div>
                ...
                <textarea rows={2} placeholder="أي تفاصيل إضافية..." value={formData.notes} onChange={e => setFormData({...formData, notes: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none resize-none" />
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm" onClick={() => setShowDetails(null)}>
          ...
          <style>
            ...
            * { font-family: 'EnglishNumbersOnly', 'GE SS Two', 'Gotham Pro', sans-serif !important; }
              ...
              }} className="px-6 py-2.5 text-[#1C5B6B] bg-blue-50 border border-blue-100 hover:bg-blue-100 font-bold rounded-xl transition flex items-center gap-2 shadow-sm">
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <select value={formData.expenseType} onChange={e => setFormData({...formData, expenseType: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="text" placeholder="وصف المصروف..." value={formData.description} onChange={e => setFormData({...formData, description: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">المورد / الجهة</label>
                  <input type="text" list={formData.expenseType === 'مشتريات مواد' ? "suppliers-list" : undefined} placeholder="اختياري..." value={formData.supplier} onChange={e => setFormData({...formData, supplier: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
                ...
                <div>
                  ...
                  <input type="text" list="projects-list" placeholder="اختياري..." value={formData.projectName} onChange={e => setFormData({...formData, projectName: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">المبلغ <span className="text-rose-500">*</span></label>
                  <input type="number" lang="en" placeholder="0.00" value={formData.amount} onChange={e => setFormData({...formData, amount: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none font-bold text-rose-600 text-lg" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">طريقة الدفع <span className="text-rose-500">*</span></label>
                  <select value={formData.paymentMethod} onChange={e => setFormData({...formData, paymentMethod: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none">
                ...
                <div>
                  ...
                  <input type="text" placeholder="اختياري..." value={formData.reference} onChange={e => setFormData({...formData, reference: e.target.value})} className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none" />
                  {['تحويل بنكي', 'شيك'].includes(formData.paymentMethod) && !formData.reference && (
