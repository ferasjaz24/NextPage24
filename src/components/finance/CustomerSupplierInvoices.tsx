...
export default function CustomerSupplierInvoices({ user, lang }: CustomerSupplierInvoicesProps) {
  ...
  const [companyInfo, setCompanyInfo] = useState({
    name: "شركة الصفحة التالية للخدمات التقنية",
  ...
  const handleTriggerPrint = async (inv: Invoice, forPdfExport: boolean = false) => {
    ...
    let companyZatcaNameAr = "شركة الصفحة التالية للخدمات التقنية للدعاية والإعلان";
          ...
          <div class="invoice-container">
            ...
            <div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 25px; border: 1.5px solid #000; border-radius: 8px; padding: 12px; background-color: #fafafa; font-family: 'EnglishNumbersOnly', 'GE SS Two', 'Gotham Pro', sans-serif; direction: rtl;">
              <div style="width: 70%; text-align: right; display: flex; flex-direction: column; justify-content: space-between; font-size: 12px; line-height: 1.6; color: #000;">
                <div>
                  <h2 style="font-size: 15px; font-weight: 800; color: #1C5B6B; margin: 0 0 4px 0;">بيانات مصدر الفاتورة (بيانات الشركة الضريبية)</h2>
                </div>
                <div>
            ...
            <div style="margin-top: 40px; border-top: 2px solid #1C5B6B; padding-top: 12px; display: flex; justify-content: space-between; align-items: flex-start; font-size: 10px; color: #111; user-select: none; direction: ltr; min-height: 80px; font-family: 'EnglishNumbersOnly', 'GE SS Two', 'Gotham Pro', sans-serif;">
              ...
              <div style="text-align: right; line-height: 1.6; width: 50%; display: flex; flex-direction: column; align-items: flex-end;">
                <div style="font-size: 11px; font-weight: bold; color: #1C5B6B; margin-bottom: 6px; font-family: 'EnglishNumbersOnly', 'GE SS Two', 'Gotham Pro', sans-serif;" dir="rtl">الحسابات البنكية المعتمدة للتحويل (Approved Bank Accounts):</div>
                    ...
                    if (list.length > 0) {
                      return list.map((b: any) => `
                        <div style="border: 1px solid #ddd; padding: 6px 10px; border-radius: 6px; background-color: #fafafa; display: inline-block; text-align: right; min-width: 250px; line-height: 1.4;" dir="rtl">
                          <div style="font-weight: bold; color: #1C5B6B; font-size: 11px;">🏦 ${b.bankName || "البنك"}</div>
                          <div style="font-size: 10px; color: #333; margin-top: 2px;"><strong>اسم الحساب:</strong> ${b.accountName || "شركة الصفحة التالية للخدمات التقنية"}</div>
                      ...
                      return `
                        <div style="border: 1px solid #ddd; padding: 6px 10px; border-radius: 6px; background-color: #fafafa; display: inline-block; text-align: right; min-width: 250px; line-height: 1.4;" dir="rtl">
                          <div style="font-weight: bold; color: #1C5B6B; font-size: 11px;">🏦 مصرف الراجحي</div>
                          <div style="font-size: 10px; color: #333; margin-top: 2px;"><strong>اسم الحساب:</strong> شركة الصفحة التالية للخدمات التقنية للدعاية والإعلان</div>
              ...
              <div className="bg-white border border-slate-150 p-8 rounded-2xl shadow-sm max-w-3xl mx-auto space-y-6">
                ...
                <div className="flex justify-between items-start border-b border-slate-100 pb-6">
                  ...
                  <div className="text-left flex flex-col items-center">
                    ...
                    <span className="text-[10px] font-bold text-indigo-800 mt-1 uppercase tracking-wider">موقع شركة الصفحة التالية</span>
                  </div>
                </div>
