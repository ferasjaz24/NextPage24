        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 bg-slate-50 border border-slate-200/60 p-1.5 rounded-2xl">
            ...
            <input
              ...
              className="px-3 py-1 text-xs font-bold border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-[#1C5B6B] bg-white text-slate-700"
            />
            {selectedMonth !== "all" && (
              <button
                onClick={() => setSelectedMonth("all")}
                className="px-2.5 py-1 text-[10px] font-black text-slate-500 hover:text-white bg-slate-200 hover:bg-[#1C5B6B] rounded-lg transition-all"
              >
                {lang === "ar" ? "الكل" : "All"}
              </button>
            )}
          ...
          <div className="relative">
            <button
              ...
              className="px-4 py-2 text-xs font-black text-white bg-[#1C5B6B] hover:bg-[#005185] rounded-xl shadow-md hover:shadow-lg transition-all duration-150 flex items-center gap-2"
            >
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-4 pr-10 py-2 text-xs border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-[#1C5B6B]"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-2 text-xs border border-slate-200 rounded-xl bg-white outline-none focus:ring-2 focus:ring-[#1C5B6B] font-semibold"
          >
                ...
                {paymentForm.paymentMethod === "Bank" ? (
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 text-xs border border-slate-200 rounded-xl bg-white outline-none focus:ring-2 focus:ring-[#1C5B6B] font-semibold"
                      required
                    >
                      {banks.map((b) => (
              ...
              <div className="bg-white p-8 rounded-2xl border shadow-sm max-w-4xl mx-auto" id="expenses-report-print-area">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-semibold text-slate-600 bg-slate-50 p-4 rounded-2xl border border-slate-100 mb-6">
                  ...
                  <div>
                    ...
                    <span className="text-[#1C5B6B] font-bold mt-0.5 block">{lang === "ar" ? "المصروفات والالتزامات المعتمدة" : "Approved Balances"}</span>
                  </div>
                </div>
