      ...
      <html dir="${lang === "ar" ? "rtl" : "ltr"}">
        <head>
          ...
          <style>
            ...
            .entry-header { display: flex; justify-content: space-between; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid #1C5B6B; }
        ...
        <body>
          ${sharedPrintHeader}
          <h2 style="text-align: center; color: #1C5B6B; margin: 30px 0;">قيد يومي (Journal Entry)</h2>
          
          <div class="entry-header">
            <div>
              <span class="label">رقم القيد</span>
              <span class="value" style="color: #1C5B6B; font-size: 18px;">${entry.id}</span>
            </div>
