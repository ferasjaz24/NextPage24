    ...
    const htmlContent = `
      ...
      <head>
        ...
        <style>
          ...
          .items-table th {
            background-color: #1C5B6B !important;
      ...
      <body>
        ...
        <div class="invoice-container">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #1C5B6B; padding-bottom: 12px; margin-bottom: 20px; user-select: none; direction: ltr;">
            <!-- معلومات الشركة -->
            ...
            <div style="text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center; width: 20%;">
              <span style="font-size: 12px; font-weight: 800; padding: 4px 12px; border: 2px solid #1C5B6B; color: #1C5B6B; border-radius: 6px; font-family: 'Tajawal', sans-serif; background-color: #f1f5f9; white-space: nowrap;">
          ...
          <div style="margin-top: 35px; display: flex; justify-content: space-between; align-items: center; border-top: 1.5px solid #000; padding-top: 15px; direction: rtl;">
            <div style="text-align: right; width: 30%;">
              ...
              <div style="font-size: 10px; color: #555; margin-top: 4px; font-weight: bold;">شركة الصفحة التالية للخدمات التقنية</div>
            ...
            <div style="text-align: left; width: 30%;">
              ...
              <div style="font-size: 10px; color: #555; margin-top: 4px; font-weight: bold;">شركة الصفحة التالية للخدمات التقنية للخدمات الصناعية</div>
              <div style="width: 150px; border-bottom: 1.5px solid #000; margin-top: 35px;"></div>
            </div>
          </div>

          <!-- Standard Corporate Footer -->
          <div style="margin-top: 45px; border-top: 2px solid #1C5B6B; padding-top: 12px; display: flex; justify-content: space-between; align-items: flex-start; font-size: 10px; color: #111; user-select: none; direction: ltr; min-height: 80px; font-family: 'Tajawal', sans-serif;">
  ...
  const runEndToEndFinancialTest = async () => {
    ...
    try {
      ...
      const testInvoice = {
        ...
        companyNameArabic: "شركة الصفحة التالية للخدمات التقنية للدعاية والإعلان",
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="bg-[#1C5B6B] hover:bg-[#005185] text-white py-2.5 px-5 rounded-xl font-bold text-sm shadow-md transition-all flex items-center gap-2"
          >
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-xl grid grid-cols-1 md:grid-cols-4 gap-4 items-end no-print">
        <div>
          ...
          <input
            ...
            className="w-full border border-slate-200 rounded-xl px-4 py-2 text-xs font-semibold text-slate-700 outline-none focus:ring-2 focus:ring-[#1C5B6B]"
            placeholder="JV-XXXX"
          />
        </div>
        <div>
          ...
          <select
            ...
            className="w-full border border-slate-200 rounded-xl px-4 py-2 text-xs bg-white font-semibold text-slate-700 outline-none focus:ring-2 focus:ring-[#1C5B6B]"
          >
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="w-full border border-slate-200 rounded-xl px-4 py-1.5 text-xs font-semibold text-slate-700 outline-none focus:ring-2 focus:ring-[#1C5B6B] bg-white"
            />
            {selectedMonth !== "all" && (
              <button
                onClick={() => setSelectedMonth("all")}
                className="px-2.5 py-1 text-[10px] font-black text-slate-500 hover:text-white bg-slate-100 hover:bg-[#1C5B6B] rounded-lg transition-all"
              >
                الكل
              </button>
            )}
        ...
        <div className="relative">
          <button
            ...
            className="w-full bg-[#005185] hover:bg-[#1C5B6B] text-white py-2 px-4 rounded-xl font-bold text-xs shadow transition-all flex items-center justify-center gap-1.5 h-[36px]"
          >
          ...
          {showJournalPrintMenu && (
            <div className="absolute left-0 right-0 mt-2 bg-white rounded-2xl shadow-2xl border border-slate-100 py-1.5 z-30 font-bold text-slate-700 text-xs text-right animate-fade-in no-print">
              ...
              <button
                ...
                className="w-full text-right px-4 py-2.5 hover:bg-slate-50 flex items-center gap-2 text-[#1C5B6B] border-t border-slate-100 transition"
              >
              ...
              <tbody className="divide-y font-semibold text-slate-600">
                {filteredEntries.map((jv) => (
                  <tr key={jv.id} className="hover:bg-slate-50 transition-colors">
                    <td className="px-6 py-4 font-mono font-bold text-[#1C5B6B]">
                      {jv.journalEntryNo}
                    </td>
      ...
      {showJournalModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-md flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-white w-full max-w-5xl rounded-3xl shadow-2xl flex flex-col overflow-hidden max-h-[90vh] border">
            <div className="bg-gradient-to-r from-[#005185] to-[#1C5B6B] p-5 text-white flex justify-between items-center shrink-0">
            ...
            <div className="bg-slate-50 p-4 border-t flex justify-end gap-2.5 shrink-0">
              ...
              <button
                ...
                className="bg-[#1C5B6B] hover:bg-[#005185] text-white font-bold py-2.5 px-6 rounded-xl text-xs transition-all shadow"
              >
                💾 حفظ سند القيد
              </button>
            </div>
          ...
          <div className="bg-white w-full max-w-3xl rounded-3xl shadow-2xl border overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4 text-xs font-semibold text-slate-600 bg-slate-50 p-4 rounded-xl border">
                ...
                <p>الحالة: <span className="font-extrabold text-[#1C5B6B]">{selectedEntry.status}</span></p>
              </div>
      ...
      {showApprovalAccountModal && approvalEntry && (
        <div className="fixed inset-0 z-50 bg-black/50 p-4 flex items-center justify-center animate-fade-in backdrop-blur-sm">
          <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl border overflow-hidden">
            <div className="bg-[#1C5B6B] p-5 text-white flex justify-between items-center">
            ...
            <div className="p-6 space-y-4">
              <div className="bg-slate-50 p-4 rounded-2xl border space-y-2 text-xs font-semibold text-slate-700 text-right" dir="rtl">
                ...
                <div className="border-t pt-2 mt-2 flex justify-between items-center">
                  <span className="font-bold text-[#1C5B6B]">{lang === "ar" ? "المبلغ الإجمالي:" : "Total Amount:"}</span>
                  <span className="font-black text-lg text-[#1C5B6B]">
                  ...
                  <button
                    ...
                    className={`p-3 rounded-xl border text-xs font-bold transition flex flex-col items-center gap-1 ${
                      selectedPaymentSource.type === "Bank"
                        ? "border-[#1C5B6B] bg-[#1C5B6B]/5 text-[#1C5B6B]"
                ...
                {selectedPaymentSource.type === "Bank" ? (
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="w-full text-xs font-semibold px-3 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 focus:border-[#1C5B6B] bg-white"
                      required
                    >
              ...
              <div className="bg-white p-8 rounded-2xl border shadow-sm max-w-4xl mx-auto text-right" id="journal-report-print-area">
                ...
                <div className="flex justify-between items-start border-b-2 border-[#005185] pb-4 mb-6">
                  <div className="text-right space-y-1">
                    <h1 className="text-base font-black text-[#005185]">{lang === "ar" ? "شركة الصفحة التالية للخدمات التقنية للخدمات الصناعية" : "Al Waleed Arts Industrial Services Co."}</h1>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-semibold text-slate-600 bg-slate-50 p-4 rounded-2xl border border-slate-100 mb-6">
                  ...
                  <div>
                    ...
                    <span className="text-[#1C5B6B] font-bold mt-0.5 block">{lang === "ar" ? "قيود اليومية العامة" : "General Ledger"}</span>
                  </div>
                </div>
                    ...
                    <tbody>
                      {filteredEntries.map((jv, idx) => (
                        <tr key={jv.id} className={`border-b border-slate-100 font-semibold ${idx % 2 === 0 ? "bg-white" : "bg-slate-50/40"}`}>
                          <td className="p-2.5 font-mono text-[#1C5B6B] font-bold">{jv.journalEntryNo}</td>
