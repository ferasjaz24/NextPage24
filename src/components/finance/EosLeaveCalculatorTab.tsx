      ...
      <div className="bg-white/80 backdrop-blur rounded-3xl p-6 border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4" id="eos-header-card">
        <div>
          <h2 className="text-2xl font-black text-slate-800 tracking-tight flex items-center gap-2">
            <Calculator className="w-7 h-7 text-[#1C5B6B]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`p-2.5 rounded-xl font-bold text-xs border transition-all text-center ${calcType === "eos" ? "bg-[#1C5B6B] text-white border-[#1C5B6B]" : "bg-slate-50 text-slate-600 hover:bg-slate-100 border-slate-200"} disabled:opacity-50`}
                  >
                  ...
                  <button
                    ...
                    disabled={!isAllowedToCalculate}
                    className={`p-2.5 rounded-xl font-bold text-xs border transition-all text-center ${calcType === "leave" ? "bg-[#1C5B6B] text-white border-[#1C5B6B]" : "bg-slate-50 text-slate-600 hover:bg-slate-100 border-slate-200"} disabled:opacity-50`}
                  >
              ...
              <div>
                ...
                <select
                  ...
                  disabled={!isAllowedToCalculate}
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl p-2.5 text-xs font-bold text-slate-700 focus:ring-2 focus:ring-[#1C5B6B] disabled:opacity-50"
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-slate-200 rounded-xl p-2.5 text-xs font-bold text-slate-700 focus:ring-2 focus:ring-[#1C5B6B] text-center"
                      />
                    </div>
                    <div>
              ...
              <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100 space-y-4" id="monthly-adjustments-section">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      <label className="block text-[10px] font-bold text-[#1C5B6B] mb-1">
                        {lang === "ar" ? "صافي راتب الشهر المحسوب" : "Calculated Net Salary"}
                      </label>
                      <div className="w-full bg-[#1C5B6B]/10 border border-[#1C5B6B]/20 rounded-xl p-2.5 text-xs font-black text-[#1C5B6B] text-center font-mono">
                        {netSalary.toLocaleString()} SAR
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <button
                          ...
                          className="text-[10px] bg-[#1C5B6B] text-white px-2 py-1 rounded-lg font-bold hover:bg-[#005185]"
                        >
                ...
                <div className="bg-white/5 p-2 rounded-2xl border border-white/10 flex items-center justify-between text-xs my-2">
                  ...
                  <div className="flex gap-1.5">
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-[10px] font-black transition-all cursor-pointer ${printLang === "ar" ? "bg-[#1C5B6B] text-white" : "bg-slate-800 text-slate-400 hover:text-white"}`}
                    >
                      عربي
                    </button>
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-[10px] font-black transition-all cursor-pointer ${printLang === "en" ? "bg-[#1C5B6B] text-white" : "bg-slate-800 text-slate-400 hover:text-white"}`}
                    >
                      English
                    </button>
                  </div>
        ...
        {!canViewFormulas ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-xs text-slate-700">
            ...
            <div className="bg-white p-4 rounded-2xl border border-slate-200 space-y-2">
              <span className="font-black text-[#1C5B6B] block text-sm">📅 {lang === "ar" ? "أيام الإجازة المستحقة سنوياً" : "Accrued Vacation Days"}</span>
            ...
            <div className="bg-white p-4 rounded-2xl border border-slate-200 space-y-2">
              <span className="font-black text-[#1C5B6B] block text-sm">💰 {lang === "ar" ? "مستحقات أيام الإجازة" : "Accrued Vacation Pay"}</span>
              <p className="text-slate-500 leading-relaxed font-bold text-[11px]">
                {lang === "ar" 
            ...
            <div className="bg-white p-4 rounded-2xl border border-slate-200 space-y-2">
              <span className="font-black text-[#1C5B6B] block text-sm">💵 {lang === "ar" ? "صافي راتب شهر الإجازة" : "Net Salary of Vacation Month"}</span>
              <p className="text-slate-500 leading-relaxed font-bold text-[11px]">
                {lang === "ar" 
      ...
      <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm space-y-6" id="saved-calculations-explorer">
        ...
        {!canViewSaved ? (
          ...
          <div className="flex justify-center items-center py-10" id="db-list-loading">
            <div className="w-8 h-8 border-3 border-[#1C5B6B] border-t-transparent rounded-full animate-spin"></div>
          </div>
