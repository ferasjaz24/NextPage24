                  ...
                  >
                    ...
                    <div className="flex justify-between items-end pt-3 border-t border-slate-200/50">
                      <div>
                        ...
                        <p className="text-xl font-extrabold text-[#1C5B6B] tracking-tight mt-0.5">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="p-2 text-slate-500 hover:text-[#1C5B6B] bg-white hover:bg-white border border-slate-200 rounded-xl text-xs font-bold transition-all"
                          title="تعديل الحساب"
                        >
                          📝 تعديل
                        </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-slate-200 rounded-xl p-2.5 text-xs font-bold focus:ring-2 focus:ring-[#1C5B6B]"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-slate-200 rounded-xl p-2.5 text-xs font-bold focus:ring-2 focus:ring-[#1C5B6B] text-center"
                    />
                  </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          ...
                          <button
                            ...
                            className="text-xs text-[#1C5B6B] font-extrabold hover:underline"
                          >
                          ...
                          <div className="bg-white p-3 rounded-xl border border-slate-200 space-y-2">
                            ...
                            <div className="flex gap-2">
                              ...
                              <button
                                ...
                                className="w-1/3 bg-[#1C5B6B] hover:bg-[#005185] text-white text-xs font-bold rounded-lg p-2"
                              >
                                {lang === "ar" ? "تأكيد" : "Add"}
                              </button>
                            </div>
      ...
      {showBankModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 animate-fade-in backdrop-blur-sm">
          <div className="bg-white w-full max-w-xl rounded-3xl shadow-2xl border border-slate-100 overflow-hidden max-h-[90vh] overflow-y-auto">
            <div className="bg-gradient-to-r from-[#005185] to-[#1C5B6B] p-5 text-white flex justify-between items-center">
            ...
            <form onSubmit={handleSaveBank} className="p-6 space-y-5">
              ...
              <div className="flex justify-end gap-3 pt-3 border-t">
                ...
                <button
                  type="submit"
                  className="bg-[#1C5B6B] hover:bg-[#005185] text-white font-bold py-2 px-6 rounded-lg text-xs transition-all"
                >
                  حفظ الحساب
                </button>
              </div>
                    ...
                    <tbody className="divide-y font-medium text-slate-600">
                      {transactions.map((tx) => (
                        <tr key={tx.id} className="hover:bg-slate-50 transition-colors">
                          <td className="px-4 py-3 font-mono text-[10px] text-[#1C5B6B] font-bold">
                            {tx.transactionNo}
                          </td>
