  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 space-y-4" id="accounting-dashboard-loading">
        <div className="w-12 h-12 border-4 border-[#1C5B6B] border-t-transparent rounded-full animate-spin"></div>
    ...
    <div className="space-y-6" id="accounting-dashboard-container">
      ...
      <div className="bg-white/80 backdrop-blur rounded-3xl p-6 border border-slate-100 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 bg-slate-100 p-1.5 rounded-2xl w-full md:w-auto">
          ...
          <select 
            ...
            className="bg-white text-slate-800 text-xs font-bold rounded-xl px-3 py-2 border-none focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none"
          >
            {monthsAr.map((m, idx) => (
          ...
          <select 
            ...
            className="bg-white text-slate-800 text-xs font-bold rounded-xl px-4 py-2 border-none focus:ring-2 focus:ring-[#1C5B6B] focus:outline-none"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div className="mt-4 pt-3 border-t border-slate-50 flex items-center justify-between text-xs">
            ...
            <span className="text-[#1C5B6B] font-semibold group-hover:translate-x-1 transition-transform flex items-center gap-0.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6" id="payroll-bento-section">
          ...
          <div>
            <div className="flex items-center justify-between mb-6">
              <h4 className="font-black text-slate-800 text-sm flex items-center gap-2">
                <Users className="w-5 h-5 text-[#1C5B6B]" />
            ...
            <p className="text-xs text-slate-500 font-semibold mb-4 leading-relaxed">
              {lang === "ar" 
                ? "إجمالي المبالغ المستحقة للأجور الشهرية والمكافآت والبدلات لشركة الصفحة التالية للخدمات التقنية مسجلة وموزعة بالكامل" 
        ...
        <div className="bg-gradient-to-br from-slate-900 via-slate-850 to-slate-950 text-white rounded-3xl p-6 flex flex-col justify-between shadow-lg relative overflow-hidden">
          ...
          <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-[#1C5B6B]/10 rounded-full filter blur-2xl"></div>
          
          <div>
            <div className="flex items-center justify-between mb-6">
              <h4 className="font-black text-sm flex items-center gap-2">
                <Calculator className="w-5 h-5 text-[#229FA0]" />
