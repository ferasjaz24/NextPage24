...
export default function CustomerInvoicesTab({ lang, user }: { lang: "ar" | "en"; user: any }) {
  ...
  const handleOpenPrintTab = (inv: CustomerInvoice) => {
    ...
    const itemsRowsHtml = (inv.items || []).map((it, idx) => `
      <tr>
        ...
        <td style="text-align: left; font-family: monospace; font-weight: 900; color: #1C5B6B;">${Number(it.lineTotal || 0).toLocaleString("en-US", { minimumFractionDigits: 2 })}</td>
      </tr>
    `).join("");
        ...
        <div class="invoice-container ${(inv.items || []).length <= 3 ? "compact-invoice" : ""}">
          ...
          <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 20px; direction: rtl;">
            <div style="display: flex; flex-direction: column; gap: 4px; text-align: right; max-width: 65%;">
              <p style="margin: 0; font-size: 13px; font-weight: 900; color: #0f172a;">${companySettings?.companyNameArabic || inv.companyNameArabic || "شركة الصفحة التالية للخدمات التقنية للدعاية والإعلان"}</p>
          ...
          <div class="meta-grid">
            <div class="meta-item">
              ...
              <span class="meta-value" style="font-family: monospace; color: #1C5B6B;">${inv.invoiceNo}</span>
            </div>
            <div class="meta-item">
          ...
          <div class="signatures">
            ...
            <div>
              <div class="sig-line" style="color: #1C5B6B; border-top-color: #1C5B6B;">توقيع المنشأة المعتمد / Authorized Signature</div>
  ...
  const handleSaveInvoice = async (isDraft: boolean) => {
    ...
    try {
      ...
      const seller = companySettings?.sellerNameForQR || companySettings?.companyNameArabic || "شركة الصفحة التالية للخدمات التقنية للدعاية والإعلان";
      ...
      const invoicePayload: CustomerInvoice = {
        ...
        companyNameArabic: companySettings?.companyNameArabic || "شركة الصفحة التالية للخدمات التقنية للدعاية والإعلان",
    ...
    <div className="bg-slate-50 min-h-screen p-4 md:p-8 space-y-6" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button
          ...
          className="bg-[#1C5B6B] hover:bg-[#005185] text-white py-3 px-6 rounded-2xl font-bold text-sm shadow-lg transition-all flex items-center gap-2"
        >
                    ...
                    <td className="px-6 py-4 text-center">
                      <div className="flex items-center justify-center gap-2">
                        <button
                          ...
                          className="bg-[#1C5B6B]/10 hover:bg-[#1C5B6B]/20 text-[#1C5B6B] py-1 px-2.5 rounded-lg text-[11px] font-bold transition-all"
                          title="عرض الفاتورة"
                        >
                          👁️ عرض
                        </button>
          ...
          <div className="bg-white w-full h-full md:max-w-7xl md:h-[95vh] md:rounded-3xl shadow-2xl flex flex-col overflow-hidden border">
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8">
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-between text-xs font-bold text-slate-700">
                ...
                <span className="text-[#1C5B6B]">ZATCA Phase 1 Ready ✔️</span>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-5 bg-sky-50/50 rounded-2xl border border-sky-100">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-xs bg-white font-semibold outline-none focus:ring-2 focus:ring-[#1C5B6B] disabled:bg-slate-50 disabled:text-slate-400"
                    >
                      <option value="">
                        {!selectedClientForInvoice 
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                ...
                <div>
                  <label className="block text-xs font-bold text-[#1C5B6B] mb-1">عُملة الفاتورة *</label>
                  <select
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-4">
                ...
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 font-bold text-slate-700 space-y-3.5">
                  ...
                  <div className="flex justify-between items-center text-base text-slate-900">
                    <span>الصافي النهائي المستحق (Grand Total):</span>
                    <span className="font-mono text-lg text-[#1C5B6B] font-extrabold">{grandTotal.toLocaleString("en-US", { minimumFractionDigits: 2 })} {invoiceForm.currency}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-5 border-t shrink-0 flex justify-end gap-3.5">
              ...
              <button
                ...
                className="bg-[#1C5B6B] hover:bg-[#005185] text-white font-bold py-3 px-8 rounded-2xl text-xs transition-all shadow-md"
              >
            ...
            <div className="p-8 space-y-6 text-slate-800 text-xs select-text leading-relaxed" id="invoice-print-area">
              ...
              <div className="flex justify-between items-start border-b border-slate-300 pb-5">
                <div className="space-y-1.5 text-right">
                  <h1 className="text-lg font-extrabold text-[#005185]">{companySettings?.companyNameArabic || selectedInvoice.companyNameArabic || "شركة الصفحة التالية للخدمات التقنية للدعاية والإعلان"}</h1>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-slate-50 rounded-xl border">
                <div>
                  ...
                  <p className="font-mono font-extrabold text-[#1C5B6B] text-sm mt-0.5">{selectedInvoice.invoiceNo}</p>
                </div>
                <div>
                  ...
                  <tbody className="divide-y font-semibold">
                    {(selectedInvoice.items || []).map((it, idx) => (
                      <tr key={it.id || idx} className="hover:bg-slate-50/40">
                        ...
                        <td className="px-3 py-2 text-left font-mono font-extrabold text-[#1C5B6B]">{Number(it.lineTotal || 0).toLocaleString("en-US", { minimumFractionDigits: 2 })}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="flex justify-between items-start gap-4">
                ...
                <div className="w-1/2 bg-slate-50 p-4 rounded-xl border font-bold space-y-2 text-right">
                  ...
                  <div className="flex justify-between text-xs text-slate-900">
                    ...
                    <span className="font-mono text-sm text-[#1C5B6B] font-extrabold">{Number(selectedInvoice.grandTotal || 0).toLocaleString("en-US", { minimumFractionDigits: 2 })} {selectedInvoice.currency || "SAR"}</span>
                  </div>
                </div>
              </div>
