...
function getCompanyAbbreviation(dept: string | undefined | null): string {
  ...
  if (normalized.includes("الصفحة التالية") || normalized.includes("faw") || normalized.includes("fanoon")) return "FAW";
...
السبب الموثق المحذوف: ${oldItem.reason}`;
  ...
  <div style="font-family: 'GE SS', 'GE SS Two', 'GE SS Two', 'Gotham Pro', sans-serif; direction: rtl; padding: 20px; color: #0f172a; width: 100%; background: white;">
        <div style="display: flex; justify-content: space-between; border-bottom: 3px solid #1C5B6B; padding-bottom: 20px; margin-bottom: 20px;">
          <div style="display: flex; align-items: center; gap: 15px;">
    <img src="https://i.postimg.cc/0jQj3XVc/black-logo-nextpage-8.png" referrerpolicy="no-referrer" alt="NextPage Co Logo" style="width: 120px; height: 120px; object-fit: contain;" />
    <div>
      <h1 style="color: #1C5B6B; margin: 0; font-size: 24px; font-weight: 900;">شركة الصفحة التالية للخدمات التقنية</h1>
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 11px; margin-bottom: 30px;">
          <thead>
            <tr>
              <th style="background-color: #1C5B6B; color: white; padding: 8px; border: 1px solid #cbd5e1; text-align: right;">رقم الإقامة/الهوية</th>
              <th style="background-color: #1C5B6B; color: white; padding: 8px; border: 1px solid #cbd5e1; text-align: right;">اسم الموظف</th>
              <th style="background-color: #1C5B6B; color: white; padding: 8px; border: 1px solid #cbd5e1; text-align: right;">المسمى الوظيفي</th>
              <th style="background-color: #1C5B6B; color: white; padding: 8px; border: 1px solid #cbd5e1; text-align: right;">الأساسي</th>
              <th style="background-color: #1C5B6B; color: white; padding: 8px; border: 1px solid #cbd5e1; text-align: right;">البدلات</th>
              <th style="background-color: #1C5B6B; color: white; padding: 8px; border: 1px solid #cbd5e1; text-align: right;">إضافي</th>
              <th style="background-color: #1C5B6B; color: white; padding: 8px; border: 1px solid #cbd5e1; text-align: right;">إجمالي الاستحقاق</th>
  ...
  const handleCreateRun = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const deptFiltered = employees.filter((emp) => {
        ...
        if (newRunForm.department === "شركة الصفحة التالية للخدمات التقنية" || newRunForm.department === "شركة ساين اكس") {
    ...
    <div>
      <h1 style="color: #1C5B6B; margin: 0; font-size: 24px; font-weight: 900;">شركة الصفحة التالية للخدمات التقنية</h1>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 40px; font-size: 13px;">
          <thead>
            <tr>
              <th style="background-color: #1C5B6B; color: white; padding: 12px; border: 1px solid #cbd5e1; text-align: right;">الاستحقاقات (Earnings)</th>
              <th style="background-color: #1C5B6B; color: white; padding: 12px; border: 1px solid #cbd5e1; text-align: right;">المبلغ (ر.س)</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="border-bottom: 1px solid #e2e8f0; padding: 12px; border: 1px solid #cbd5e1; background-color: #f8fafc; font-weight: bold; font-family: 'Gotham Pro', sans-serif; font-weight: 900; font-size: 14px; color: #1C5B6B;">${selectedPayslipEmployee.totalEntitlements.toLocaleString('en-US')} ر.س</td>
        ...
        <div style="background-color: #f1f5f9; padding: 15px; border-radius: 8px; font-size:11px; color:#475569; margin-bottom: 30px;">
          <strong>تنويه نظامي:</strong> يعتبر كشف الراتب الصادر من منصة الإدارة لشركة الصفحة التالية للخدمات التقنية وثيقة رسمية معتمدة تثبت تحويل وقيد المستحقات المالية للموظف بالمرجع البنكي المعتمد إلكترونياً، وتطابق أحكام عقود العمل المصادق عليها عبر منصة قوى بوزارة الموارد البشرية.
        </div>
  ...
  return (
    <div className="space-y-6 md:col-span-1">
      ...
      <div className="bg-slate-900 text-white rounded-3xl p-6 shadow-xl border border-slate-800">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2 text-[#229FA0]">
            ...
            <h1 className="text-2xl font-black tracking-tight flex items-center gap-2">
              مسيرات الرواتب الشهرية والتحويلات <span className="text-[#229FA0]">💳</span>
            </h1>
          ...
          {isAccountant && (
            <button
              ...
              className="px-6 py-3.5 bg-gradient-to-r from-[#229FA0] to-[#1C5B6B] hover:from-[#1C5B6B] hover:to-[#229FA0] text-white font-extrabold rounded-2xl text-xs uppercase tracking-wider transition-all shadow-lg flex items-center gap-2 group transform hover:scale-[1.02]"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-slate-800">
          ...
          <div className="bg-slate-950/50 p-4 rounded-2xl border border-slate-800/80 flex flex-col justify-between">
            ...
            <div className="flex items-baseline justify-between mt-2">
              <span className="text-xl font-black text-[#229FA0] font-mono font-bold">
                {departments.length}
              </span>
              <span className="text-[10px] bg-cyan-500/10 text-[#229FA0] font-bold px-1.5 py-0.5 rounded">ورشة</span>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-4 pr-12 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#1C5B6B] focus:bg-white transition-all text-xs text-slate-700"
            />
          </div>
          ...
          {[
            ...
            <button
              ...
              className={`pb-3 px-4 text-sm font-black transition-all whitespace-nowrap border-b-2 ${
                activeTab === tab.id
                  ? "border-[#1C5B6B] text-[#1C5B6B] font-extrabold"
      ...
      <div className="bg-white rounded-3xl shadow-md border border-slate-100 overflow-hidden">
        {loading ? (
          <div className="py-24 text-center">
            <span className="w-10 h-10 border-4 border-[#1C5B6B] border-t-transparent rounded-full animate-spin inline-block mb-3"></span>
                    ...
                    <td className="py-4 px-6 text-left">
                      <div className="flex items-center justify-end gap-2.5">
                        <button
                          ...
                          className="px-4 py-2 bg-[#1C5B6B] hover:bg-[#229FA0] text-white rounded-xl font-bold transition-all flex items-center gap-1.5 shadow-sm text-sm"
                        >
        ...
        <div className="fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-4 backdrop-blur-xs">
          <div className="w-full max-w-xl bg-white rounded-3xl p-8 relative shadow-2xl border border-slate-100 animate-scale-up">
            ...
            <div className="flex items-center gap-3 mb-6">
              <span className="p-3 bg-blue-50 text-[#1C5B6B] rounded-2xl">
            ...
            <form onSubmit={handleCreateRun} className="space-y-4 text-xs">
              ...
              <div>
                ...
                />
                <p className="text-[10.5px] text-[#1C5B6B] mt-1 font-bold">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3.5 py-3 border border-slate-250 rounded-xl focus:outline-none focus:border-[#1C5B6B]"
                />
              </div>
              ...
              <div className="flex gap-3 justify-end pt-4">
                ...
                <button
                  type="submit"
                  className="px-7 py-2.5 bg-gradient-to-r from-[#1C5B6B] to-[#229FA0] text-white font-extrabold rounded-xl shadow-md transform active:scale-95 transition-all"
                >
            ...
            <div className="flex justify-between items-center bg-white px-6 py-4 border-b border-slate-200 shadow-sm z-10">
              <div className="space-y-0.5">
                <div className="flex items-center gap-2.5">
                  <span className="font-mono text-sm font-black text-[#1C5B6B]">{selectedRun.payrollNumber}</span>
                        ...
                        <>
                          <button
                            ...
                            className={`px-4 py-2 text-white font-extrabold rounded-xl text-xs shadow-md transition-all flex items-center gap-1.5 font-arabic ${
                              isSyncing 
                                ? "bg-[#1C5B6B]/70 cursor-not-allowed opacity-80" 
                                : "bg-[#1C5B6B] hover:bg-[#229FA0] active:scale-95"
                            }`}
      ...
      <div className="bg-slate-900 text-white p-4 font-black flex justify-between items-center text-xs rounded-t-2xl font-arabic">
                    ...
                    <span className="bg-slate-800 px-3 py-1 rounded-full text-[#229FA0] font-mono font-bold">{runEmployees.length} موظف</span>
                    ...
                    <table className="w-full min-w-[2200px] text-xs sm:text-[13px] text-right font-sans border-collapse relative">
                      <thead className="sticky top-0 bg-slate-100 shadow-md z-20 border-b border-slate-200">
                        <tr className="text-slate-700 font-extrabold text-xs uppercase bg-slate-100">
                          ...
                          <th className="py-4 px-3 text-right text-[#1C5B6B]">بدلات أخرى</th>
                          ...
                          return filtered.map((originalEmp) => {
                            ...
                            return (
                              <tr key={emp.id} className="border-b border-slate-100/50 hover:bg-slate-50/50 transition-colors">
                                ...
                                <td className="py-4 px-3 font-mono font-bold text-[#1C5B6B] text-center"><InlineEditable mod={getFieldMod(originalEmp, "otherAllowances")} value={emp.otherAllowances} onSave={(val) => handleInlineSave(emp.id, "otherAllowances", val)} disabled={!canModifyRow || !isAccountant} runStatus={selectedRun.status} /></td>
                        ...
                        {runModificationRequests.map((req) => (
                          <div key={req.id} className="bg-slate-50 p-3 rounded-xl border border-slate-150 space-y-1 text-[11px]">
                            <div className="flex justify-between items-center">
                              <span className="font-black text-[#1C5B6B] font-mono">{req.id}</span>
            ...
            <div className="flex justify-between items-center bg-white px-6 py-4 border-t border-slate-200 shadow-md z-10">
              <div className="text-xs text-slate-500 font-arabic">
                بيئة عمل مسير الرواتب الإلكتروني الموحد لشركة الصفحة التالية للخدمات التقنية
              </div>
              <div className="flex items-center gap-3">
                <button
          ...
          <div className="w-full max-w-4xl mx-auto bg-white min-h-screen sm:min-h-0 sm:rounded-3xl p-6 sm:p-10 relative shadow-2xl border border-slate-200 flex flex-col justify-between">
            ...
            <div className="border-b-2 border-slate-200 pb-6 mb-8">
              <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div>
                  <h2 className="text-xl sm:text-2xl font-black text-slate-900">شركة الصفحة التالية للخدمات التقنية</h2>
                  <p className="text-xs sm:text-sm text-slate-500 font-mono mt-1">NextPage Co</p>
                </div>
                <div className="text-right sm:text-left">
                  <span className="px-3.5 py-1.5 bg-sky-50 text-[#1C5B6B] text-xs font-black rounded-full border border-sky-100">
              ...
              <h1 className="text-base sm:text-lg font-extrabold text-slate-800 mt-6 flex items-center gap-2 border-r-4 border-[#1C5B6B] pr-3">
                    ...
                    <div className="flex justify-between items-center py-1">
                      <span className="text-slate-600 font-medium">
                        ...
                        {selectedPayslipEmployee.otherAllowancesReason && (
                          <span className="text-[10px] bg-sky-100 text-[#1C5B6B] px-2 py-0.5 rounded-md mr-1.5 font-bold">
                            {selectedPayslipEmployee.otherAllowancesReason}
                          </span>
                        )}
                      </span>
            ...
            <div className="mt-8 p-6 bg-slate-900 text-white rounded-2xl space-y-4">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-1">
                <div className="space-y-1 text-center sm:text-right">
                  <span className="text-xs font-bold text-[#229FA0] uppercase tracking-wider font-mono">NET REMAINING SALARY</span>
            ...
            <div className="mt-8 bg-slate-50 p-4 rounded-xl border border-slate-200 text-[10.5px] text-slate-600 leading-relaxed">
              <strong>تنويه نظامي معتمد:</strong> يعتبر كشف الراتب الصادر من منصة الإدارة لشركة الصفحة التالية للخدمات التقنية وثيقة رسمية معتمدة تثبت تحويل وقيد المستحقات المالية للموظف بالمرجع البنكي المعتمد إلكترونياً، وتطابق أحكام عقود العمل المصادق عليها عبر منصة قوى بوزارة الموارد البشرية.
            </div>
