      ...
      bodyHtml = `
        <div style="font-family: 'Gotham Pro', 'GE SS Two', sans-serif; direction: rtl; text-align: right;">
          ...
          <div style="text-align: center; margin-bottom: 20px;">
            <h1 style="font-size: 18px; font-weight: 900; color: #1C5B6B; margin: 0 0 4px 0;">إقرار ضريبة القيمة المضافة المبسط</h1>
          ...
          <table style="width: 100%; margin-bottom: 16px; font-size: 10px; border: 1px solid #e2e8f0; border-collapse: collapse;">
            <tbody>
              ...
              <tr>
                ...
                <td style="padding: 6px 10px; border: 1px solid #e2e8f0; font-family: monospace; font-weight: bold; color: #1C5B6B;">${refNo}</td>
              </tr>
              <tr style="background-color: #f8fafc;">
          ...
          <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-bottom: 16px;">
            <div style="border: 1px solid #e2e8f0; padding: 10px; border-radius: 6px; background-color: #f0f9ff; border-right: 4px solid #1C5B6B;">
          ...
          <div style="border: 1px solid #e2e8f0; padding: 8px 12px; border-radius: 6px; background-color: #fafafa; margin-bottom: 16px; text-align: center; font-size: 10px; display: flex; align-items: center; justify-content: space-around;">
            ...
            <div style="color: #94a3b8; font-weight: bold;">=</div>
            <div>
              <span style="color: #1C5B6B; display: block; font-size: 8px;">صافي الضريبة الربعية</span>
          ...
          <!-- Tables Breakdown -->
          <h3 style="font-size: 11px; font-weight: 900; color: #0f172a; margin: 0 0 6px 0; padding-bottom: 4px; border-bottom: 1px solid #1C5B6B;">تفاصيل بنود الإقرار الضريبي</h3>
          <table style="width: 100%; font-size: 9px; border: 1px solid #e2e8f0; border-collapse: collapse; margin-bottom: 24px;">
            ...
            <tbody>
              ...
              <tr style="background-color: #f8fafc; font-weight: bold;">
                ...
                <td style="padding: 6px 10px; border: 1px solid #e2e8f0; text-align: left; font-family: monospace; color: #1C5B6B;">${totalSalesVat.toLocaleString("en-US", { minimumFractionDigits: 2 })}</td>
              </tr>
              <tr style="background-color: #f8fafc; font-weight: bold;">
              ...
              <tr style="background-color: #f0fdf4; font-weight: 900; font-size: 10px; border-top: 2px solid #1C5B6B;">
      ...
      bodyHtml = `
        <div style="font-family: 'Gotham Pro', 'GE SS Two', sans-serif; direction: rtl; text-align: right;">
          ...
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 8px; margin-bottom: 16px;">
            ...
            <div style="border: 1px solid #e2e8f0; padding: 8px; border-radius: 6px; background-color: #f0f9ff; border-right: 3px solid #1C5B6B;">
