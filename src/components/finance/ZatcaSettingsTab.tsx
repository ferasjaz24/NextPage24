...
const defaultSettings: ZatcaSettings = {
  ...
  district: "الياسمين",
  sellerNameForQR: "شركة الصفحة التالية للخدمات التقنية للدعاية والإعلان",
  vatEnabled: true,
  defaultVatRate: 15,
  zatcaPhase: "Phase 1",
  environment: "Sandbox",
...
export default function ZatcaSettingsTab({ lang, user }: { lang: "ar" | "en"; user: any }) {
  ...
  // Test state for QR
  const [testSeller, setTestSeller] = useState("شركة الصفحة التالية للخدمات التقنية للدعاية والإعلان");
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#1C5B6B]"></div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-slate-50 min-h-screen p-4 md:p-8" dir="rtl">
      <div className="max-w-6xl mx-auto bg-white rounded-3xl border border-slate-100 shadow-xl overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#005185] to-[#1C5B6B] p-6 text-white flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
        ...
        <form onSubmit={handleSave} className="p-6 md:p-8 space-y-8">
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-extrabold text-[#005185] border-r-4 border-[#1C5B6B] pr-3 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#1C5B6B] focus:border-transparent transition-all outline-none"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#1C5B6B] focus:border-transparent transition-all outline-none font-mono"
                />
              </div>
              <div>
              ...
              <div className="flex items-center gap-4 mt-6">
                <label className="flex items-center gap-2 cursor-pointer font-bold text-slate-700">
                  <input
                    ...
                    className="w-5 h-5 rounded text-[#1C5B6B] focus:ring-[#1C5B6B] border-slate-300"
                  />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#1C5B6B] focus:border-transparent transition-all outline-none font-mono disabled:bg-slate-100"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                ...
                <select
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#1C5B6B] focus:border-transparent transition-all outline-none bg-white"
                >
              ...
              <div className="col-span-1 md:col-span-2 lg:col-span-3">
                ...
                <textarea
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-2 text-xs focus:ring-2 focus:ring-[#1C5B6B] focus:border-transparent transition-all outline-none font-mono"
                />
              </div>
          ...
          <div className="flex justify-end gap-4">
            <button
              type="submit"
              disabled={saving}
              className="bg-[#1C5B6B] hover:bg-[#005185] text-white py-3 px-8 rounded-2xl font-bold transition-all shadow-lg hover:shadow-xl flex items-center gap-2 text-sm disabled:opacity-55"
            >
              {saving ? (
                <>
