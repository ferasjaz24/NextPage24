        ...
        <form onSubmit={(e) => e.preventDefault()} className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-4 border border-slate-200 rounded-xl space-y-4 bg-slate-50">
              <h3 className="font-bold text-[#1C5B6B]">{lang === "ar" ? "من (المرسل)" : "From (Source)"}</h3>
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]"
                >
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]"
              />
            </div>
          ...
          <div className="flex justify-between items-center pt-6 border-t border-slate-100">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={loading}
                className="px-6 py-2 bg-[#1C5B6B] text-white rounded-xl font-semibold hover:bg-[#005a96] transition-colors flex items-center gap-2 disabled:opacity-50"
              >
