      ...
      <html lang="ar" dir="rtl">
        <head>
          ...
          <style>
            ...
            .page-title { color: #1C5B6B; text-align: center; border-bottom: 2px solid #1C5B6B; padding-bottom: 10px; margin-bottom: 20px; font-size: 20px; font-weight: bold; }
              ...
              <table class="details-table" style="width: 100%; border: 1px solid #cbd5e1; text-align: right;">
                 ...
                 ${selected.map((item) => `
                   <tr style="border-bottom: 1px solid #e2e8f0;">
                     ...
                     <td style="padding: 10px; border: 1px solid #e2e8f0; font-weight: black; color: #1C5B6B;">${item.currentQty || 0}</td>
      ...
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#1C5B6B] hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl font-bold transition shadow-md shadow-blue-200"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-[#1C5B6B] text-sm font-bold text-slate-700"
              placeholder={
              ...
              <tr>
                <th className="p-4 w-10">
                  <input
                    ...
                    className="w-5 h-5 accent-[#1C5B6B] cursor-pointer rounded-md border-slate-300"
                  />
                </th>
                  ...
                  >
                    <td className="p-4 w-10">
                      <input
                        ...
                        className="w-5 h-5 accent-[#1C5B6B] cursor-pointer rounded-md shadow-sm border-slate-300"
                      />
                    </td>
                    ...
                    <td className="p-4">
                      <div className="font-bold text-slate-600 text-xs">
                        <span className="text-sm font-black text-[#1C5B6B]">
                          {item.currentQty}
                        </span>{" "}
                        {item.uom}
                      </div>
          ...
          <div className="bg-white w-full max-w-2xl h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <div className="flex justify-center">
                ...
                >
                  <div
                    className={`w-32 h-32 rounded-3xl border-2 border-dashed flex flex-col items-center justify-center transition-all ${editingItem.imageUrl ? "border-transparent bg-slate-50" : "border-slate-300 hover:border-[#1C5B6B] bg-slate-50 hover:bg-blue-50/50"}`}
                  >
                    {editingItem.imageUrl ? (
                      ...
                      <>
                        <ImageIcon className="w-8 h-8 text-slate-400 mb-2 group-hover:text-[#1C5B6B] transition-colors" />
                        <span className="text-[10px] font-bold text-slate-400 group-hover:text-[#1C5B6B]">
                          صورة المادة
                        </span>
                      </>
                    )}
              ...
              <div className="bg-slate-50 border border-slate-150 p-5 rounded-3xl space-y-4 shadow-sm relative">
                <div className="absolute -top-3 right-5 bg-[#1C5B6B] text-white px-3 py-1 rounded-lg text-[10px] font-black tracking-widest shadow-sm">
                  المعلومات الأساسية
                </div>
            ...
            <div className="p-6 border-t border-slate-100 bg-white grid grid-cols-2 gap-4 shrink-0">
              ...
              <button
                onClick={handleSave}
                disabled={isSaving}
                className="flex items-center justify-center gap-2 py-3 bg-[#1C5B6B] hover:bg-blue-700 text-white rounded-xl font-black transition text-sm shadow-md active:scale-95 disabled:opacity-75"
              >
