      ...
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
        <div>
          <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
            <Package className="w-7 h-7 text-[#1C5B6B]" />
            {lang === "ar"
        ...
        <div className="bg-slate-100 p-1.5 rounded-2xl flex gap-1 border border-slate-200">
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-black transition-all ${
              activePortal === "orders"
                ? "bg-[#1C5B6B] text-white shadow-md shadow-blue-200"
                  ...
                  <tr key={req.id} className="hover:bg-slate-50/80 transition">
                    ...
                    <td className="p-3.5 text-center flex items-center justify-center gap-2">
                      <button
                        ...
                        className="px-3.5 py-1.5 bg-slate-100 hover:bg-[#1C5B6B] text-slate-700 hover:text-white rounded-lg border border-slate-200 hover:border-transparent transition text-[10px] font-black cursor-pointer shadow-sm"
                      >
                  ...
                  <button
                    onClick={() => {
                      ...
                      let html = `
                        ...
                        <body>
                          <h2 style="text-align: center; color: #1C5B6B;">${lang === "ar" ? "أمر شراء مواد" : "Material Purchase Order"}</h2>
                    ...
                    {!showFilterPanel ? (
                      ...
                      <div className="w-full animate-in slide-in-from-top-4 duration-300">
                        ...
                        <button
                          ...
                          className={`${isSendingToPricing ? "opacity-50" : ""} w-full max-w-md mx-auto py-3 px-6 bg-[#1C5B6B] hover:bg-blue-700 text-white rounded-xl text-xs font-bold transition flex items-center justify-center gap-2 shadow-md shadow-blue-100 cursor-pointer`}
                        >
                          💸{" "}
                          {lang === "ar"
