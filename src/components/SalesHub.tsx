...
export default function SalesHub({ lang, user, quotations }: SalesHubProps) {
  ...
  const printClientDetails = (client: Client) => {
    ...
    const printContent = `
      <div style="font-family: 'EnglishNumbersOnly', 'GE SS Two', 'Gotham Pro', Tahoma, Arial; direction: rtl; text-align: right; padding: 20px;">
        <h2 style="color: #1C5B6B; text-align: center; border-bottom: 2px solid #1C5B6B; padding-bottom: 10px;">سجل وملخص العميل</h2>
  ...
  if (loading) return <div className="p-10 text-center animate-pulse text-[#1C5B6B] font-bold text-xl">جاري تحميل العملاء...</div>;
    ...
    <div className="space-y-6 animate-fade-in font-sans" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-white p-6 rounded-3xl shadow-sm border border-slate-100 gap-4">
        ...
        <div className="flex flex-wrap gap-2 justify-end">
          ...
          <button onClick={() => setIsClientModalOpen(true)} className="flex items-center gap-2 px-5 py-2 bg-[#1C5B6B] hover:bg-sky-700 text-white rounded-xl text-xs font-black shadow-lg shadow-[#1C5B6B]/20 transition">
      ...
      <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-3 text-xs font-bold text-slate-600">
        <div className="col-span-1 md:col-span-2">
          ...
          <input 
            ...
            placeholder="..."
            className="w-full p-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:border-[#1C5B6B]"
          />
        </div>
        <div>
                 ...
                 <div className="p-5 bg-slate-50 border-t border-slate-100 animate-fade-in relative space-y-5">
                   ...
                   <div className="flex flex-wrap gap-2 pt-4 border-t border-slate-200">
                     ...
                     <button 
                       ...
                       className="flex items-center gap-2 px-4 py-2 bg-[#1C5B6B] hover:bg-sky-700 text-white rounded-xl text-xs font-black transition"
                     >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-fade-in" dir="rtl">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh]">
            <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">
              <h3 className="font-extrabold text-[#1C5B6B] flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-2.5 border border-slate-300 rounded-xl outline-none focus:border-[#1C5B6B]"
              ...
              <div className="bg-slate-50 p-4 border rounded-xl space-y-4">
                <div className="flex items-center gap-3 bg-white p-3 border rounded-lg shadow-sm w-fit cursor-pointer" onClick={() => setEditingClient({...editingClient, taxExempt: !editingClient?.taxExempt})}>
                  <input 
                    ...
                    onChange={() => {}}
                    className="w-5 h-5 cursor-pointer accent-[#1C5B6B]"
                  />
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
              <div className="flex gap-2">
                 <button 
                  ...
                  className="px-6 py-2.5 bg-[#1C5B6B] hover:bg-sky-700 text-white rounded-xl text-sm font-black shadow-lg shadow-[#1C5B6B]/20 transition flex items-center gap-2"
                >
