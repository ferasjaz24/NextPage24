    ...
    <div className="space-y-6" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-slate-100 mb-6 flex-wrap gap-4">
        ...
        <div className="flex gap-3 items-center">
           ...
           <button onClick={() => setIsAddRepModalOpen(true)} className="bg-[#1C5B6B] hover:bg-[#005A96] text-white px-5 py-2.5 rounded-xl transition flex items-center gap-2 text-sm font-bold shadow-lg shadow-indigo-100">
