...
export default function ProductionHub({
  ...
  const handlePrintDailyReport = () => {
    ...
    const htmlContent = `
      <html>
        <head>
          <title>${lang === "ar" ? "تقرير المخرجات والتركيبات الميدانية - شركة الصفحة التالية" : "Siting Report - Al-Waleed"}</title>
          <style>
            ...
            .divider {
              height: 4px;
              background: linear-gradient(to left, #1C5B6B, #38bdf8);
              margin-bottom: 20px;
              border-radius: 2px;
            }
        ...
        <body>
          <div class="page">
            <table class="header-table">
              <tr>
                <td class="header-logo" style="width: 40%;">
                  شركة الصفحة التالية للدعاية والإعلان
            ...
            <div class="footer">
              <div>شركة الصفحة التالية للدعاية والإعلان والتركيبات الميدانية | الرياض، المملكة العربية السعودية</div>
            ...
            <div class="item-card">
              ...
              ${item.crew && Array.isArray(item.crew) && item.crew.length > 0 ? `
                <div style="margin-top: 15px; padding: 12px; border: 1px dashed #cbd5e1; border-radius: 8px;">
                  ...
                  <div class="value" style="font-weight: bold; color: #1C5B6B;">${item.crew.map((c: any) => c.name || c).join('، ')}</div>
                </div>
              ` : ''}
          ...
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                <Building2 className="w-7 h-7 text-[#1C5B6B]" />
                {lang === "ar"
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-4 lg:gap-6 text-[11px] text-slate-500 font-bold bg-slate-50/70 p-2.5 px-4 rounded-xl border border-slate-100 shrink-0">
                    <div>
                      ...
                      <span className="text-[#1C5B6B] font-extrabold">
                        {req.createdBy}
                      </span>
                    </div>
                  ...
                  <div className="flex items-center gap-3 shrink-0 justify-end">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-slate-100 hover:bg-[#1C5B6B] text-slate-700 hover:text-white rounded-xl transition font-black text-[10px] cursor-pointer"
                    >
                      🛠️{" "}
                      {lang === "ar"
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-slate-50 p-4 rounded-xl w-full gap-4">
                    ...
                    <div className="flex items-center gap-3 w-full sm:w-auto justify-end shrink-0">
                      ...
                      <button
                        ...
                        className="p-2 bg-white border border-slate-200 hover:bg-slate-100 text-[#1C5B6B] rounded-full transition cursor-pointer shadow-sm shrink-0"
                        title={
                          lang === "ar"
                        ...
                        {ord.designFileType === "file" && ord.designFile ? (
                          <div className="flex gap-2 items-center">
                            <button
                              ...
                              className="px-3 py-1 bg-indigo-600 hover:bg-[#1C5B6B] text-white rounded-lg font-black inline-flex items-center gap-1 transition text-xs shadow-sm"
                            >
                          ...
                          <a
                            ...
                            className="px-3 py-1 bg-indigo-600 hover:bg-[#1C5B6B] text-white rounded-lg font-black inline-flex items-center gap-1 transition"
                          >
                            <ExternalLink className="w-3 h-3" />
                            {lang === "ar"
      ...
      {activeSubTab === "prod_installation" && (
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
              <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                <Truck className="w-7 h-7 text-[#1C5B6B]" />
                {lang === "ar"
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-[10px] font-black transition ${
                  installationPortal === "orders"
                    ? "bg-[#1C5B6B] text-white shadow-md"
                    : "text-slate-500 hover:text-[#1C5B6B]"
                }`}
              >
                🚚{" "}
                {lang === "ar"
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 flex-1">
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <span className="text-xs bg-[#1C5B6B]/5 text-[#1C5B6B] font-extrabold px-2.5 py-0.5 rounded-full border border-[#1C5B6B]/15">
              ...
              <div className="flex gap-2">
                ...
                {installationPortal === "requests" ? (
                  <button
                    ...
                    className="px-4 py-2 bg-[#1C5B6B] hover:bg-blue-700 text-white rounded-xl font-black text-xs cursor-pointer transition shadow"
                  >
                    🚀{" "}
                    {lang === "ar"
                    ...
                    >
                      ...
                      <div className="space-y-0.5 text-right flex-1">
                        ...
                        <p className="text-[11px] text-slate-400 font-bold">
                          ...
                          | كوتيشن:{" "}
                          <span className="text-[#1C5B6B] font-mono font-bold">
                            {req.quotationNumber}
                          </span>
                        </p>
                      </div>
                    ...
                    {installationPortal === "requests" && (
                      <>
                        ...
                        <button
                          ...
                          className="px-3.5 py-2.5 bg-[#1C5B6B] hover:bg-blue-700 text-white rounded-xl transition text-[11px] font-black cursor-pointer shadow-md animate-pulse"
                        >
                          🚀{" "}
                  ...
                  <button
                    ...
                    className={`py-2.5 px-3 rounded-xl border text-center font-black transition flex items-center justify-center gap-1.5 ${
                      dailyProcedureType === "installation"
                        ? "bg-[#1C5B6B]/10 text-[#1C5B6B] border-[#1C5B6B]/40 shadow-sm"
                        : "bg-slate-50 text-slate-600 border-slate-200 hover:bg-slate-100"
                    }`}
                  >
                    <span>🏗️</span>
          ...
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 space-y-5 animate-in zoom-in-95 text-right border relative">
              ...
              <button
                onClick={() => {
                  ...
                  const htmlContent = `
                    <html>
                      <head>
                        <title>${lang === "ar" ? "سند إنجاز تركيب ميداني - شركة الصفحة التالية" : "Field Siting Report - Al-Waleed"}</title>
                        <style>
                      ...
                      <body>
                        <div class="page">
                          ...
                          <div class="grid">
                            ...
                            <div class="card">
                              <div class="field"><span class="label">نوع الإجراء:</span> <span class="value" style="font-weight: bold; color: #1C5B6B;">${procedureTypeLabel}</span></div>
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                ...
                <span className="font-black text-[#1C5B6B] text-sm">
        ...
        <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-sm z-[1500] flex items-center justify-center p-4 overflow-y-auto">
          ...
          >
            ...
            <div className="space-y-2 border border-slate-100 p-3 rounded-2xl text-xs">
              <h4 className="font-extrabold text-[#1C5B6B] flex items-center gap-1">
                    ...
                    <div className="pt-3 space-y-3 animate-in fade-in duration-200">
                      ...
                      {!associatedProc.isOrder && (
                        <div className="bg-indigo-50/40 p-3 rounded-xl border border-indigo-100 flex flex-col gap-2.5">
                          <p className="font-extrabold text-[#1C5B6B] text-[11px] mb-1">
                            ➕{" "}
                            {lang === "ar"
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                  {!selectedInbound.isOrder && (
                    <button
                      ...
                      className="px-5 py-2.5 bg-[#1C5B6B] hover:bg-blue-700 text-white font-black rounded-xl text-xs cursor-pointer transition shadow-md whitespace-nowrap"
                    >
                      🚀{" "}
                ...
                {inboundPortal === "completed" && (() => {
                  ...
                  return (
                    <div className="space-y-4 text-xs leading-relaxed max-h-96 overflow-y-auto pr-1 border-t border-slate-100 pt-4 mt-4">
                      <h4 className="font-extrabold text-[#1C5B6B] mb-2 flex items-center gap-1">
        ...
        <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-sm z-[1500] flex items-center justify-center p-4 overflow-y-auto">
          ...
          >
            <div className="flex justify-between items-start border-b border-slate-100 pb-3">
              <div>
                <h3 className="font-extrabold text-[#1C5B6B] text-sm flex items-center gap-1.5">
                  ⚙️{" "}
                  {lang === "ar"
            ...
            <div className="pt-3 flex justify-between items-center border-t">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-5 py-2.5 bg-slate-900 hover:bg-[#1C5B6B] text-white font-extrabold rounded-xl transition text-xs shadow-md cursor-pointer inline-flex items-center gap-1"
                >
                  ▶️{" "}
                  {lang === "ar"
          ...
          >
            <div className="flex justify-between items-center border-b pb-3">
              ...
              <button
                ...
                className="px-3.5 py-1.5 bg-[#1C5B6B] hover:bg-[#005c99] text-white rounded-xl text-xs font-black transition shadow-sm cursor-pointer"
              >
            ...
            <div className="space-y-3.5 text-xs text-slate-600 font-bold leading-relaxed">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border space-y-1.5">
                ...
                <p className="border-t pt-1.5 mt-1.5">
                  ...
                  <strong className="text-[#1C5B6B] font-black">
                    {Math.ceil(
          ...
          >
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto text-xs font-bold leading-normal text-slate-600 pr-1">
              {stages.map((st, i) => (
                ...
                >
                  <div className="flex justify-between items-center text-[#1C5B6B]">
                    <span>
                      🎯{" "}
                      {lang === "ar"
        ...
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm z-[1500] flex items-center justify-center p-4">
          ...
          >
            <div className="flex justify-between items-start border-b pb-2">
              <div>
                <h3 className="font-extrabold text-[#1C5B6B] text-sm">
                  ⛓️{" "}
                  {lang === "ar"
          ...
          >
            ...
            <div className="flex gap-2 justify-end pt-2">
              ...
              <button
                ...
                className={`px-4 py-2 text-white font-bold text-xs rounded-xl transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed ${confirmDialog.isDestructive ? "bg-red-600 hover:bg-red-700" : "bg-[#1C5B6B] hover:bg-blue-700"}`}
              >
                {confirmDialog.countdown && confirmDialog.countdown > 0
