    ...
    <div className="space-y-6" dir={lang === "ar" ? "rtl" : "ltr"}>
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4">
        <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
          <Building className="w-7 h-7 text-[#1C5B6B]" />
          {lang === "ar"
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
          <input
            ...
            className="w-full sm:w-64 px-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]"
          />
          <input
            type="month"
            value={filterMonth}
            onChange={(e) => setFilterMonth(e.target.value)}
            className="w-full sm:w-48 px-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]"
          />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredRequests.map((r, i) => (
            ...
            >
              ...
              <button className="mt-4 md:mt-0 px-4 py-2 bg-slate-50 text-[#1C5B6B] hover:bg-blue-50 border border-blue-100 rounded-xl font-bold text-sm transition">
          ...
          <div className="bg-white rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl relative animate-in fade-in zoom-in-95 duration-300">
            ...
            <div className="p-8">
              <h2 className="text-2xl font-black text-slate-800 mb-6 flex items-center gap-2 border-b pb-4">
                <Target className="w-6 h-6 text-[#1C5B6B]" />
                {lang === "ar"
              ...
              <div className="mb-6 border border-slate-200 rounded-2xl overflow-hidden">
                <table className="w-full text-left text-sm border-collapse">
                  <thead className="bg-[#1C5B6B]/5 border-b border-slate-200 text-[#1C5B6B]">
                    <tr>
                    ...
                    {selectedReq.pricingDetails?.map((q: any, idx: number) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-3 text-center font-bold text-[#1C5B6B] bg-[#1C5B6B]/5">
                            {total.toFixed(2)}
                          </td>
                        </tr>
                      );
                  ...
                  <tfoot className="bg-[#1C5B6B]/10 border-t-2 border-[#1C5B6B]/20">
                    <tr>
                      <td
                        colSpan={5}
                        className="p-3 font-black text-left text-[#1C5B6B]"
                      >
                        {lang === "ar"
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl border border-slate-100">
            ...
            <div className="flex bg-slate-50 border-t border-slate-100 p-4 gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-[#1C5B6B] text-white font-extrabold text-sm rounded-xl hover:bg-blue-700 transition shadow-md"
              >
