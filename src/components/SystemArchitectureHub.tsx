    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2 bg-slate-100 p-1.5 rounded-2xl border border-slate-200/60">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${activePane === 'erd' ? 'bg-[#1C5B6B] text-white shadow' : 'text-slate-600 hover:bg-slate-200/50'}`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${activePane === 'workflow' ? 'bg-[#1C5B6B] text-white shadow' : 'text-slate-600 hover:bg-slate-200/50'}`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${activePane === 'bom' ? 'bg-[#1C5B6B] text-white shadow' : 'text-slate-600 hover:bg-slate-200/50'}`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${activePane === 'rbac' ? 'bg-[#1C5B6B] text-white shadow' : 'text-slate-600 hover:bg-slate-200/50'}`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${activePane === 'audit' ? 'bg-[#1C5B6B] text-white shadow' : 'text-slate-600 hover:bg-slate-200/50'}`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${activePane === 'roadmap' ? 'bg-[#1C5B6B] text-white shadow' : 'text-slate-600 hover:bg-slate-200/50'}`}
        >
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="p-4 bg-slate-50 rounded-2xl text-slate-700 border border-slate-200/70 overflow-x-auto">
              ...
              <div className="min-w-[800px] flex justify-center py-6">
                <svg width="840" height="340" viewBox="0 0 840 340" className="w-full h-auto">
                  {/* Entity Box: Clients */}
                  <rect x="20" y="40" width="160" height="100" rx="12" fill="#EBF5FF" stroke="#1C5B6B" strokeWidth="2" />
                  ...
                  <text x="195" y="80" fill="#1C5B6B" fontWeight="black" fontSize="11">1 : M</text>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center bg-slate-50 px-4 py-2 rounded-xl text-xs font-bold text-slate-700 font-mono">
                ...
                <button
                  onClick={handleCopy}
                  className="flex items-center gap-1.5 bg-[#1C5B6B] hover:bg-[#1C5B6B]/90 text-white rounded-lg px-2.5 py-1 text-[11px] cursor-pointer"
                >
            ...
            <div className="overflow-x-auto rounded-2xl border border-slate-100">
              <table className="w-full text-xs text-right border-collapse">
                ...
                <tbody className="divide-y divide-slate-100 font-medium text-slate-600">
                  <tr>
                    <td className="p-3 border-b font-extrabold text-[#1C5B6B]">Super Admin (Feras)</td>
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/50 flex flex-col md:flex-row gap-4 justify-between items-start">
                <div className="space-y-1">
                  <span className="px-2.5 py-0.5 bg-[#1C5B6B] text-white rounded font-bold uppercase text-[9px]">Sprint 1: Schema Setup</span>
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/50 flex flex-col md:flex-row gap-4 justify-between items-start">
                <div className="space-y-1">
                  <span className="px-2.5 py-0.5 bg-[#1C5B6B] text-white rounded font-bold uppercase text-[9px]">Sprint 2: Workflow Engine</span>
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/50 flex flex-col md:flex-row gap-4 justify-between items-start">
                <div className="space-y-1">
                  <span className="px-2.5 py-0.5 bg-[#1C5B6B] text-white rounded font-bold uppercase text-[9px]">Sprint 3: Factory Automation</span>
