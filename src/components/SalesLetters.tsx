...
في البداية، نود أن نشكركم على ثقتكم الغالية باختيار "شركة الصفحة التالية للخدمات التقنية" لتنفيذ وتصنيع متطلباتكم لمشروع ({{اسم_المشروع}}).
...
نبعث إليكم أطيب تحياتنا في "شركة الصفحة التالية للخدمات التقنية"، متمنين لكم دوام التوفيق والنجاح.
...
تهنئكم "شركة الصفحة التالية للخدمات التقنية" بباكورة الانتهاء من مشروع ({{اسم_المشروع}}) وفقاً لعرض السعر رقم ({{رقم_العرض}})، والذي تم تسليم أعماله بنجاح ولله الحمد وفقاً للضوابط والمعايير المتفق عليها.
...
في حال الانقضاء دون معالجة جذرية، تحتفظ "شركة الصفحة التالية للخدمات التقنية" بجميع حقوقها القانونية والنظامية الكاملة باللجوء إلى الطرق الرسمية والقضائية المعمول بها في وزارة العدل والمحاكم المختصة لاسترداد الحقوق وفرض غرامات التأخير أو التعويضات الناتجة، ولنا الأمل ألا نضطر لهذه الخطوة و نكتفي بحسّهم المهني وتفهمكم.
              ...
              <div style="width: 210mm; height: 297mm; padding: 3cm; box-sizing: border-box; display: flex; flex-direction: column; position: relative; background: white;">
                ...
                ${showStamp ? `
                  <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; z-index: 10; margin-top: -4rem; margin-bottom: -2rem;">
                    <p style="color: #64748b; font-weight: bold; font-size: 13px; margin-bottom: 4px; background: rgba(255,255,255,0.7); padding: 0 8px; border-radius: 4px;">ختم شركة الصفحة التالية</p>
              ...
              ${logItem.title.includes('دفعة') || logItem.title.includes('سداد') || logItem.title.includes('مالي') || logItem.title.includes('مطالبة') ? `
                <div class="page-break" style="page-break-before: always; width: 210mm; height: 297mm; padding: 3cm; box-sizing: border-box; display: flex; flex-direction: column; position: relative; background: white; margin-top: 20px;">
                  ...
                  <div style="flex-grow: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; padding-top: 40px;">
                    <h2 style="font-size: 18px; font-weight: bold; color: #1e293b; margin-bottom: 30px; border-bottom: 2px solid #4f46e5; padding-bottom: 8px;">البيانات البنكية لشركة الصفحة التالية للخدمات التقنية</h2>
                ...
                <div id="printable-sales-letter" className="relative mx-auto bg-white shadow print:shadow-none print:m-0 overflow-hidden" style={{ width: '210mm', height: '297mm', padding: '3cm', boxSizing: 'border-box', display: 'flex', flexDirection: 'column' }}>
                  ...
                  {user?.role !== 'Sales Rep' && (
                    <div className="flex flex-col items-center justify-center relative z-10 pointer-events-none" style={{ marginTop: '-4rem', marginBottom: '-2rem' }} contentEditable={false}>
                      <p className="text-slate-500 font-bold mb-1 text-sm bg-white/70 px-2 rounded">ختم شركة الصفحة التالية</p>
                ...
                {docCategory === 'financial' && (
                  <div id="printable-sales-letter-page2" className="page-break relative mx-auto mt-8 bg-white shadow print:shadow-none print:m-0 overflow-hidden" style={{ width: '210mm', height: '297mm', padding: '3cm', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', pageBreakBefore: 'always' }}>
                    ...
                    <div className="flex-grow flex flex-col items-center justify-center pt-10">
                      <h2 className="text-xl font-bold text-slate-800 mb-8 border-b-2 border-indigo-500 pb-2">البيانات البنكية لشركة الصفحة التالية للخدمات التقنية</h2>
                      ...
                      <tr key={idx} className="border-b border-slate-50 hover:bg-slate-50 transition">
                        ...
                        <td className="p-3 text-center flex items-center justify-center gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 bg-slate-100 hover:bg-[#1C5B6B] text-slate-700 hover:text-white rounded-lg border border-slate-200 transition text-[11px] font-bold cursor-pointer"
                          >
            ...
            {exportLogs.length > 5 && (
              <div className="flex justify-center mt-6 pt-4 border-t border-slate-100">
                <button
                  ...
                  className="px-6 py-2.5 bg-indigo-50 hover:bg-indigo-150 text-[#1C5B6B] hover:text-[#005A96] font-black rounded-2xl transition text-xs shadow-sm shadow-indigo-100/50 cursor-pointer flex items-center gap-1.5"
                >
                  {showAllLogs ? (
        ...
        <div id="sales-letter-preview-modal" className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-3xl max-w-4xl w-full shadow-2xl border border-slate-150 flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-150" dir="rtl">
            ...
            <div className="p-6 md:p-8 bg-slate-100 overflow-y-auto flex-grow flex justify-center">
              ...
              >
                {/* Formal Header */}
                <div className="border-b-2 border-[#1C5B6B] pb-4 mb-6 flex justify-between items-center w-full">
                  <div className="text-right">
                    <h1 className="text-[#1C5B6B] text-lg font-black">{lang === 'ar' ? 'شركة الصفحة التالية للخدمات التقنية' : 'NextPage Co for Tech Services'}</h1>
                    <p className="text-slate-500 text-[10px] mt-0.5 font-bold">
                      {lang === 'ar' ? 'مملوكة لمؤسسة الصفحة التالية التجارية | ترخيص صناعي رقم 44110511855' : 'Owned by Al Waleed Trading Est. | Industrial License No. 44110511855'}
                    </p>
                  </div>
                  <img src="https://i.postimg.cc/0jQj3XVc/black-logo-nextpage-8.png" referrerPolicy="no-referrer" className="h-20 object-contain" alt="Logo" />
                </div>
                ...
                {(previewLog.status === 'approved' || user?.role !== 'Sales Rep') ? (
                  <div className="flex flex-col items-center justify-center relative z-10 pointer-events-none mt-4 mb-2">
                    <p className="text-slate-500 font-bold mb-1 text-xs bg-white/70 px-2 rounded">ختم شركة الصفحة التالية</p>
                ...
                <div className="border-t border-slate-200 pt-3 mt-auto text-[10px] text-slate-500 font-bold">
                  <div className="flex justify-between items-center w-full">
                    ...
                    <p>NextPage Co for Tech Services</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50 flex flex-col sm:flex-row justify-between items-center gap-3">
              ...
              <div className="flex gap-3">
                ...
                <button 
                  ...
                  className="px-6 py-2.5 bg-[#1C5B6B] hover:bg-[#005A96] text-white font-extrabold rounded-xl transition flex items-center gap-2 shadow-lg shadow-blue-100 text-sm cursor-pointer"
                >
