    ...
    <div className="space-y-6" dir={lang === "ar" ? "rtl" : "ltr"}>
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 mb-6 flex flex-col md:flex-row gap-4 items-center justify-between">
        <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
          <Tag className="w-7 h-7 text-[#1C5B6B]" />
          {lang === "ar"
        ...
        <div className="flex bg-slate-100 p-1 rounded-2xl w-full md:w-auto overflow-hidden">
          <button
            ...
            className={`flex-1 md:flex-none px-6 py-2.5 rounded-xl text-sm font-bold transition whitespace-nowrap ${activePortal === "requests" ? "bg-white text-[#1C5B6B] shadow" : "text-slate-600 hover:text-slate-800"}`}
          >
            {lang === "ar" ? "الطلبات المرسلة للتسعير" : "Pricing Requests"}
          </button>
          <button
            onClick={() => setActivePortal("suppliers")}
            className={`flex-1 md:flex-none px-6 py-2.5 rounded-xl text-sm font-bold transition whitespace-nowrap ${activePortal === "suppliers" ? "bg-white text-[#1C5B6B] shadow" : "text-slate-600 hover:text-slate-800"}`}
          >
      ...
      <body dir="rtl">
        ...
        <div style="margin-top: 15px; margin-bottom: 20px; border: 1.5px solid #000; padding: 12px; border-radius: 6px; background-color: #f9fafb; font-size: 12px; line-height: 1.6; font-family: 'EnglishNumbersOnly', 'GE SS Two', 'Gotham Pro', sans-serif;">
          <table style="width: 100%; border: none; margin: 0; font-size: 12px;">
            ...
            ` : ""}
            <tr style="border: none;">
              <td style="border: none; padding: 4px;" colspan="2"><strong>حالة الطلب الحالية:</strong> <span style="font-weight: bold; color: #1C5B6B;">${selectedReq.status}</span></td>
            </tr>
          </table>
        </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-bold text-[#1C5B6B] font-mono">{selectedReq.id || "---"} {selectedReq.quotationNumber ? `(${selectedReq.quotationNumber})` : ""}</p>
                </div>
                <div>
                  <p className="text-slate-500 font-bold mb-1">
                      ...
                      <tr key={idx} className="border-b">
                        <td className="p-2 font-bold">
                          ...
                          {(() => {
                            ...
                            if (defSup) {
                              return (
                                <span className="inline-block mt-1 text-[10px] bg-sky-50 text-[#1C5B6B] px-2 py-0.5 rounded-md font-bold">
                    ...
                    {selectedReq.updatesLog.map((log: any, i: number) => (
                      ...
                      >
                        <span className="font-bold text-slate-700">
                          {log.action}{" "}
                          <span className="text-[#1C5B6B] font-black px-1">
                            بواسطة ({log.user})
                          </span>
                        </span>
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl animate-in fade-in duration-300 border border-slate-100">
            ...
            <div className="flex bg-slate-50 border-t border-slate-100 p-4 gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-[#1C5B6B] text-white font-extrabold text-sm rounded-xl cursor-pointer hover:bg-blue-700 shadow-md transition"
              >
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4 mb-4 flex-wrap">
        ...
        <button
          ...
          className="px-5 py-3 bg-[#1C5B6B] text-white rounded-2xl font-bold flex gap-2 items-center"
        >
          ...
          <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden">
            ...
            <div className="p-6 bg-slate-50 border-t flex gap-3">
              ...
              <button
                disabled={isSaving}
                onClick={handleSave}
                className="flex-1 py-3 bg-[#1C5B6B] hover:bg-[#005a96] text-white rounded-xl font-bold transition"
              >
