...
export default function MainDashboard({
 ...
 <div className="w-10 h-10 border-4 border-[#1C5B6B]/20 border-t-[#1C5B6B] rounded-full animate-spin"></div>
 ...
 if (!hasAnyDashboardMetric) {
   return (
     <div className="space-y-8 pb-12 animate-in fade-in duration-300">
       {/* Welcome Hero Banner */}
       <div className="relative overflow-hidden bg-gradient-to-r from-[#0a2540] via-[#1C5B6B] to-[#00558c] rounded-3xl p-8 lg:p-10 text-white shadow-xl">
         <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
           <div className="space-y-3 max-w-2xl">
             <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur border border-white/20 text-xs font-bold tracking-wide text-blue-100">
               ...
               <span>{lang === "ar" ? "نظام شركة الصفحة التالية للخدمات التقنية" : "NextPage Co ERP"}</span>
             </div>
       ...
       <div className="space-y-4">
         <div className="flex items-center justify-between">
           <h2 className="text-xl font-black text-[#0a2540] flex items-center gap-2">
             <LayoutDashboard className="w-5 h-5 text-[#1C5B6B]" />
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
           {canAccessModule(user, 'hr') && (
             <div 
               ...
               className="group bg-white rounded-3xl p-6 border border-slate-200 hover:border-[#1C5B6B] shadow-sm hover:shadow-xl transition-all cursor-pointer flex flex-col justify-between space-y-5"
             >
               <div className="space-y-3">
                 <div className="w-12 h-12 rounded-2xl bg-blue-50 text-[#1C5B6B] flex items-center justify-center font-bold text-xl group-hover:scale-110 transition-transform">
                   <Users className="w-6 h-6" />
                 </div>
                 <h3 className="font-black text-lg text-[#0a2540] group-hover:text-[#1C5B6B] transition-colors">
               ...
               <div className="pt-2 flex items-center justify-between border-t border-slate-100 text-xs font-bold text-[#1C5B6B]">
       ...
       <div className="bg-blue-50/60 border border-blue-100 rounded-2xl p-4 flex items-center gap-3 text-xs text-blue-800 font-medium">
         <Sparkles className="w-5 h-5 text-[#1C5B6B] shrink-0" />
         <p>
           {lang === "ar"
 ...
 <button
 onClick={fetchData}
 className="bg-[#1C5B6B]/10 hover:bg-[#1C5B6B]/20 text-[#1C5B6B] p-2.5 rounded-xl "
 >
 ...
 <TrendingUp className="w-6 h-6 text-[#1C5B6B]" />
 {lang === "ar"
 ...
 className="hidden sm:flex items-center gap-2 text-sm font-bold text-[#1C5B6B] hover:text-[#0a2540] px-4 py-2 bg-slate-50 rounded-xl hover:bg-slate-100"
 >
 ...
 <div>
 <h2 className="text-2xl font-black text-[#0a2540] flex items-center gap-3">
 <Settings className="w-6 h-6 text-[#1C5B6B]" />
 {lang === "ar" ? "مركز التحكم بالإنتاج" : "Production Center"}
 </h2>
 <p className="text-sm font-medium text-slate-400 mt-1.5">
 {lang === "ar"
 ...
 <div>
 <h2 className="text-2xl font-black text-[#0a2540] flex items-center gap-3">
 <Package className="w-6 h-6 text-[#1C5B6B]" />
 {lang === "ar"
 ? "المشتريات والمستودع"
 ...
 <div>
 <h2 className="text-2xl font-black text-[#0a2540] flex items-center gap-3">
 <Briefcase className="w-6 h-6 text-[#1C5B6B]" />
 ...
 {/* 5. QUICK ACTIONS */}
 {canViewShortcuts && (
 <section className="bg-gradient-to-l from-[#1C5B6B] to-[#0a2540] p-6 lg:p-8 rounded-[28px] text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
 ...
 <Activity className="w-5 h-5 text-[#1C5B6B]" />
 ...
 <p className="text-[10px] font-bold text-[#1C5B6B] bg-[#1C5B6B]/10 inline-block px-1.5 py-0.5 rounded mt-1">
 ...
 className="text-sm font-bold text-[#1C5B6B] hover:text-[#0a2540] "
 >
 {showAllLogs
 ? lang === "ar"
 ? "عرض القليل"
