    ...
    const html = `
      ...
      <head>
        ...
        <style>
          ...
          .print-title { font-size: 24px; font-weight: bold; text-align: center; margin-bottom: 30px; color: #1C5B6B; border-bottom: 2px dashed #e2e8f0; padding-bottom: 15px;}
          .section-title { font-size: 18px; font-weight: bold; color: #334155; margin-top: 30px; margin-bottom: 15px; background: #f1f5f9; padding: 10px 15px; border-right: 4px solid #1C5B6B; border-radius: 4px;}
