...
export function getIqamaStatus(
  ...
  if (diffDays < 0) {
    ...
    return {
      ...
      daysLeft: diffDays,
      badgeClass: "bg-blue-50/50 text-[#1C5B6B] border border-blue-100",
    };
  }
}
    ...
    return (
      <div className="bg-white rounded-3xl shadow-sm border border-slate-200 flex flex-col overflow-hidden">
        ...
        {fileData ? (
          ...
          <label className="w-full min-h-[16rem] bg-slate-50 flex flex-col items-center justify-center text-slate-400 hover:bg-[#1C5B6B]/5 hover:text-[#1C5B6B] transition-colors cursor-pointer p-8">
...
export default function HrEmployeeDirectoryTab({
  ...
  const [newEmpForm, setNewEmpForm] = useState({
    ...
    bankNotes: "",
    company: "شركة الصفحة التالية للخدمات التقنية",
  });
    ...
    try {
      ...
      const printHTML = `
        <div style="font-family: 'EnglishNumbersOnly', 'GE SS Two', 'Gotham Pro', Arial, sans-serif; max-width: 800px; margin: 0 auto; direction: rtl;">
          <!-- Header -->
          <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #1C5B6B; padding-bottom: 8px; margin-bottom: 16px;">
            <div style="text-align: right; direction: rtl;">
              <h2 style="font-size: 24px; font-weight: 900; color: #374151; margin: 0;">شركة الصفحة التالية للخدمات التقنية</h2>
              <h3 style="font-size: 11px; font-weight: bold; color: #6b7280; margin: 4px 0 0 0; letter-spacing: 0.1em; direction: ltr; text-align: right;">NextPage Co</h3>
            </div>
            <div>
              <img src="https://i.postimg.cc/0jQj3XVc/black-logo-nextpage-8.png" alt="Logo" style="height: 100px; object-fit: contain;" />
            </div>
          </div>
          <h1 style="text-align: center; color: #1C5B6B; margin-bottom: 20px; font-size: 20px;">سجل الموظف الشامل | Employee Profile Record</h1>
            ...
            <div style="flex-grow: 1;">
              ...
              <div style="display: flex; gap: 24px; margin-bottom: 12px;">
                <div style="flex: 1; border-bottom: 1px solid #f3f4f6; padding-bottom: 8px;">
                  ...
                  <strong style="color: #1C5B6B; font-family: monospace; font-size: 16px;">${selectedEmp.id}</strong>
                </div>
                <div style="flex: 1; border-bottom: 1px solid #f3f4f6; padding-bottom: 8px;">
          ...
          <!-- Section: Basic Info -->
          <h3 style="color: #1C5B6B; font-size: 16px; margin-bottom: 12px; border-bottom: 2px solid #1C5B6B; padding-bottom: 4px; display: inline-block;">البيانات الأساسية Basic Info</h3>
          ...
          <h3 style="color: #1C5B6B; font-size: 16px; margin-bottom: 12px; border-bottom: 2px solid #1C5B6B; padding-bottom: 4px; display: inline-block;">تفاصيل العقد Contract Details</h3>
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px 32px; margin-bottom: 24px; font-size: 14px;">
            <div style="border-bottom: 1px dashed #e5e7eb; padding-bottom: 6px;">
          ...
          <div style="page-break-inside: avoid;">
            <h3 style="color: #1C5B6B; font-size: 16px; margin-bottom: 12px; border-bottom: 2px solid #1C5B6B; padding-bottom: 4px; display: inline-block;">العهد المسجلة Custody Assets</h3>
          ...
          ${
            selectedEmp.iqamaPhoto || selectedEmp.passportPhoto
              ? `
          <div style="page-break-inside: avoid;">
            <h3 style="color: #1C5B6B; font-size: 16px; margin-bottom: 12px; border-bottom: 2px solid #1C5B6B; padding-bottom: 4px; display: inline-block;">الإثباتات المرفقة Attached Documents</h3>
          ...
          <!-- Footer -->
          <div style="margin-top: 30px; border-top: 1px solid #1C5B6B; padding-top: 16px; display: flex; justify-content: space-between; font-size: 10px; color: #4b5563;" dir="ltr">
             <div style="line-height: 1.6;">
                <p style="margin:0;"><span style="font-weight:bold; color:#1C5B6B;">T:</span> +966 13 833 4115</p>
                <p style="margin:0;"><span style="font-weight:bold; color:#1C5B6B;">Factory:</span> Dallah Industrial District, Dammam 32445, Saudi Arabia.</p>
             </div>
             <div style="text-align:right; line-height: 1.6;">
                <p style="margin:0;">info@nextpage.co | www.nextpage.co</p>
                <p style="margin:0;"><span style="font-weight:bold; color:#1C5B6B;">Riyad Bank Iban:</span> SA6 320 000 003 220 402 999 901</p>
             </div>
          </div>
        </div>
      `;
  ...
  return (
    <div id="hr-employee-directory-tab" className="space-y-6">
      ...
      >
        <div>
          <h2 className="text-xl font-black text-[#1C5B6B] flex items-center gap-2">
            <span>👥</span>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            className="px-5 py-3 bg-[#1C5B6B] hover:bg-[#1C5B6B]/90 text-white font-extrabold text-xs rounded-2xl flex items-center gap-2 transition-all shadow-md select-none"
          >
      ...
      <div className="bg-white/95 backdrop-blur-md rounded-2xl border border-slate-100 shadow-sm p-4 space-y-3" dir="rtl">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-4 pr-11 py-3 text-sm bg-slate-50 border border-slate-200 rounded-xl text-right font-bold text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#1C5B6B] focus:ring-1 focus:ring-[#1C5B6B] transition-all"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <select
            ...
            className="px-3 py-2 text-xs font-bold bg-slate-50 border border-slate-200 rounded-xl text-slate-700 outline-none focus:border-[#1C5B6B] cursor-pointer min-w-[150px]"
          >
                ...
                >
                  <td className="p-4 pr-6">
                    <div className="flex items-center gap-3">
                      <div
                        className="w-9 h-9 rounded-xl bg-blue-50 hover:bg-blue-100 text-[#1C5B6B] flex items-center justify-center font-black text-sm shadow-inner cursor-pointer transition-colors"
                      ...
                      <div>
                        <p
                          className="font-extrabold text-slate-800 text-[13px] cursor-pointer hover:text-[#1C5B6B] hover:underline transition-all"
                          onClick={() => handleOpenViewMore(emp)}
                        >
                        ...
                        {emp.mobile && (
                          <p
                            className="text-[10px] text-[#1C5B6B] font-mono font-bold mt-0.5"
                            dir="ltr"
                          >
                            {emp.mobile}
                          </p>
                  ...
                  <td className="p-4">
                    <div className="flex flex-col gap-1 items-start">
                      ...
                      {emp.classification && (
                        <span className="px-2 py-0.5 text-[9px] font-bold bg-[#1C5B6B]/10 text-[#1C5B6B] rounded">
                  ...
                  <td className="p-4 pl-6 text-center">
                    <div className="flex items-center justify-center gap-2">
                      <button
                        onClick={() => handleOpenViewMore(emp)}
                        className="px-3 py-2 bg-blue-50 hover:bg-blue-100 text-[#1C5B6B] font-extrabold text-[11px] rounded-xl transition-all flex items-center gap-1.5 shadow-sm cursor-pointer"
                        title={
                          lang === "ar"
      ...
      {selectedEmp && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={handlePrint}
              className="absolute top-4 left-16 p-2 bg-[#1C5B6B] hover:bg-[#1C5B6B]/90 text-white rounded-xl transition-all cursor-pointer z-10 print:hidden"
              title={
                lang === "ar"
            ...
            <div className="w-full p-6 overflow-y-auto print:overflow-visible relative">
              ...
              <div className="border-b border-slate-100 pb-4 ml-6 mb-4">
                <span className="text-[9px] bg-[#1C5B6B]/10 text-[#1C5B6B] font-black px-2.5 py-1 rounded-md uppercase tracking-wider">
                  🏷️ ID: {selectedEmp.id}
                </span>
              ...
              <div className="flex gap-2 mb-6 border-b border-slate-100 pb-2 print:hidden">
                <button
                  ...
                  className={`px-4 py-2 font-bold text-sm rounded-xl transition-all ${modalTab === "info" ? "bg-[#1C5B6B] text-white shadow" : "bg-slate-50 text-slate-500 hover:bg-slate-100"}`}
                >
                  {lang === "ar" ? "المعلومات الأساسية" : "Basic Info"}
                </button>
                <button
                  onClick={() => setModalTab("attachments")}
                  className={`px-4 py-2 font-bold text-sm rounded-xl transition-all ${modalTab === "attachments" ? "bg-[#1C5B6B] text-white shadow" : "bg-slate-50 text-slate-500 hover:bg-slate-100"}`}
                >
                  {lang === "ar"
                    ? "المرفقات والمستندات"
              ...
              >
                <div className="bg-slate-50/70 p-5 rounded-2xl border border-slate-150/70">
                  <div className="flex justify-between items-center mb-4 pb-2 border-b border-slate-100">
                    <h4 className="font-extrabold text-[#1C5B6B] text-xs flex items-center gap-1.5/5">
                      <span>👤</span>
                      {lang === "ar"
                    ...
                    {!isEditing && (
                      <button
                        ...
                        className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-[#1C5B6B] font-extrabold rounded-lg flex items-center gap-1 transition-all"
                      >
                        <Edit2 className="w-3 h-3 text-[#1C5B6B]/80" />
                        <span>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <option value="شركة الصفحة التالية للخدمات التقنية">شركة الصفحة التالية للخدمات التقنية</option>
    ...
    muddah: 0,
                      ...
                      <div className="col-span-1 md:col-span-2 border-t border-slate-100 pt-3 mt-1">
                        <h4 className="text-xs font-black text-[#1C5B6B] mb-2">
                          {lang === "ar"
                            ? "التأمين الطبي"
                            : "Medical Insurance"}
                        </h4>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-right">
                      ...
                      <div>
                        ...
                        <p className="font-extrabold text-[#1C5B6B]">
                          {selectedEmp.company || "شركة الصفحة التالية للخدمات التقنية"}
                        </p>
                      </div>
                      <div>
                        <span className="text-[10px] text-slate-400 block font-bold">
                        ...
                        <div className="flex flex-col items-start gap-1">
                          ...
                          {selectedEmp.classification && (
                            <span className="inline-block mt-1 px-2.5 py-0.5 text-[10px] font-black bg-[#1C5B6B]/10 text-[#1C5B6B] rounded-md">
                              {selectedEmp.classification}
                            </span>
                          )}
                        </div>
                      ...
                      <div className="col-span-2 border-t pt-2 mt-2">
                        <span className="text-xs text-[#1C5B6B] block font-black mb-2">
                      ...
                      <div className="col-span-1 sm:col-span-2 bg-[#1C5B6B]/5 p-3.5 rounded-xl border border-[#1C5B6B]/10 flex justify-between items-center text-xs mt-2">
                        ...
                        <div className="text-left">
                          <span className="font-mono text-lg font-black text-[#1C5B6B] bg-[#1C5B6B]/15 px-3 py-1 rounded-lg">
      ...
      contractExpiry: selectedEmp.contractExpiry || "",
                        ...
                        className="px-3 py-1 bg-[#1C5B6B]/10 hover:bg-[#1C5B6B]/20 text-[#1C5B6B] font-extrabold text-[11px] rounded-lg transition-all cursor-pointer"
                      >
                        {lang === "ar"
                          ? "تعديل الراتب والعقد"
  ...
  >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 text-right">
        <div>
          ...
          <input
            ...
            className="w-full bg-white border border-slate-200 rounded-lg px-3 py-1.5 text-xs text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 transition-all text-right font-extrabold"
          />
        </div>
        <div>
          <label className="block text-slate-400 font-bold mb-1 text-[10px]">
          ...
          <input
            ...
            className="w-full bg-white border border-slate-200 rounded-lg px-3 py-1.5 text-xs text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/20 transition-all text-right font-bold"
          />
        </div>
        <div>
          <label className="block text-slate-400 font-bold mb-1 text-[10px]">
    ...
    <div className="flex gap-2 justify-end pt-2">
      ...
      <button
        type="submit"
        className="px-4 py-2 bg-[#1C5B6B] hover:bg-[#005a96] text-white font-extrabold text-xs rounded-xl transition-all shadow-sm"
      >
            ...
            {selectedEmp.contractExpiry || "-"}
                  ...
                  {isEditingBankInfo ? (
                    ...
                    >
                      ...
                      <div className="flex gap-2 text-xs font-black pt-2">
                        <button
                          type="submit"
                          className="flex-1 bg-[#1C5B6B] hover:bg-[#1C5B6B]/95 text-white py-2 rounded-xl flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                        >
                          <Check className="w-4 h-4" />
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-right">
                        ...
                        <div className="p-3 bg-slate-50/60 rounded-xl border border-slate-100/70">
                          ...
                          <p className="font-bold text-[#1C5B6B] mt-0.5 text-xs">
                      ...
                      {selectedEmp.bankNotes && (
                        <div className="p-3 bg-blue-50/30 rounded-xl border border-blue-100/30 text-right">
                          <span className="block text-[10px] text-[#1C5B6B] font-bold">
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-150 space-y-4">
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="w-full py-2 bg-[#1C5B6B] hover:bg-[#1C5B6B]/95 text-white font-black text-xs rounded-xl transition-all shadow-sm cursor-pointer"
                    >
                      ⚡{" "}
                      {lang === "ar"
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 pt-4 border-t border-slate-100">
                <h4 className="text-sm font-black text-[#1C5B6B] mb-4">
                  {lang === "ar"
            ...
            <div className="flex gap-2 text-xs font-black pt-4">
              <button
                type="submit"
                className="flex-1 bg-[#1C5B6B] hover:bg-[#1C5B6B]/95 text-white py-2.5 rounded-xl transition-all shadow-md cursor-pointer"
              >
