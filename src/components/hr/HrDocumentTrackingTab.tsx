      ...
      <html lang="${lang}" dir="${isAr ? 'rtl' : 'ltr'}">
        <head>
          ...
          <style>
            ...
            h2 { color: #1C5B6B; text-align: center; margin-bottom: 5px; }
    ...
    <div id="hr-document-tracking-tab" className="space-y-6 text-right" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gradient-to-l from-slate-900 via-blue-950 to-slate-900 p-6 rounded-3xl border border-white/10 text-white shadow-xl">
        <div className="space-y-1">
          <h2 className="text-xl font-black flex items-center gap-2">
            <FileText className="w-6 h-6 text-[#229FA0] animate-bounce" />
        ...
        <div className="flex flex-wrap gap-2">
          <button
            onClick={() => {
              ...
              setAddEmpForm({
                employeeId: 'CORP-01',
                employeeName: 'شركة الصفحة التالية للخدمات التقنية (المركز الرئيسي)',
            ...
            className="px-4 py-2 bg-[#229FA0] hover:bg-[#1C5B6B] text-slate-950 hover:text-white font-black text-xs rounded-xl transition-all shadow-md shadow-[#229FA0]/20 flex items-center gap-1.5"
          >
      ...
      <div className="flex border-b border-slate-100 gap-1 bg-white p-1 rounded-2xl border">
        <button
          ...
          className={`flex-1 py-3 text-xs font-black rounded-xl transition-all flex items-center justify-center gap-2 ${
            activePortal === 'employee'
              ? 'bg-[#1C5B6B] text-white shadow-md shadow-[#1C5B6B]/20'
      ...
      <div className="bg-white/95 p-5 rounded-3xl border border-slate-100 shadow-sm space-y-4 text-right">
        <div className="flex items-center justify-between pb-2 border-b border-slate-50">
          <div className="flex items-center gap-2">
            <SlidersHorizontal className="w-4 h-4 text-[#1C5B6B]" />
          ...
          <button
            ...
            className="text-[10px] font-black text-[#1C5B6B] hover:underline"
          >
          ...
          <div className="relative">
            ...
            <div className="relative">
              <input
                ...
                className="w-full text-xs pr-8 pl-3 py-2 bg-slate-50 border border-slate-200 rounded-xl font-bold text-right text-slate-700 focus:outline-none focus:border-[#1C5B6B]"
              />
              ...
              <div>
                ...
                >
                  ...
                  {Array.from(new Set(employeeDocs.map(d => JSON.stringify({id: d.employeeId, name: d.employeeName}))))
                    ...
                    .map((parsed, i, arr) => {
                      if (parsed.name && parsed.name.includes('الصفحة التالية')) {
                        const firstWaleed = arr.findIndex(item => item.name && item.name.includes('الصفحة التالية'));
                        if (firstWaleed !== i) {
      ...
      <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden text-right">
        <div className="p-4 bg-slate-50 border-b flex justify-between items-center">
          <h4 className="text-xs font-black text-[#1C5B6B]">
            {activePortal === 'employee' 
                    ...
                    <tr key={docObj.id} className="border-b border-slate-50 hover:bg-slate-50 transition-colors">
                      {activePortal === 'employee' ? (
                        <>
                          ...
                          <td className="p-3 font-extrabold text-[#1C5B6B]">{docObj.docType}</td>
                      ...
                      <td className="p-3 text-center">
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <button
                            ...
                            className={`p-1.5 rounded-lg transition-all ${docObj.docFile || docObj.docUrl ? 'bg-blue-50 text-blue-600 hover:bg-[#1C5B6B] hover:text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'}`}
      ...
      <div className="bg-slate-50 p-5 rounded-3xl border border-slate-200/50 space-y-3 text-right">
        <h4 className="text-xs font-black text-[#1C5B6B] flex items-center gap-1.5 justify-start">
          <Clock className="w-4 h-4 text-[#1C5B6B]" />
          ...
          {activityLogs.map(log => (
            <div key={log.id} className="text-[10px] bg-white p-2.5 rounded-xl border border-slate-100 flex justify-between items-center gap-4">
              ...
              <div className="flex-1 text-slate-700">
                ...
                <strong className="text-[#1C5B6B]">{log.docType} ({log.docNumber})</strong>{' '}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={isAr ? 'مثال: شركة الصفحة التالية للخدمات التقنية (المركز الرئيسي)' : 'e.g. NextPage Co (Main HQ)'}
                    />
                  </div>
                ...
                <div className="p-4 bg-slate-50 rounded-2xl border border-dashed border-slate-300 space-y-2 text-right">
                  ...
                  {addEmpForm.docFile ? (
                    ...
                    <label className="flex flex-col items-center justify-center py-4 bg-white rounded-xl border border-slate-200 cursor-pointer hover:bg-slate-50 transition-colors">
                      <Upload className="w-6 h-6 text-[#1C5B6B] mb-1 animate-pulse" />
          ...
          <div className="bg-white rounded-3xl w-full max-w-lg p-6 shadow-2xl border border-slate-100 space-y-4">
            ...
            <div className="text-right space-y-2 bg-slate-50 p-3 rounded-2xl border text-xs">
              <div>
                ...
                <span className="text-[#1C5B6B] font-bold">
      ...
      {isViewDocOpen && selectedViewDoc && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="bg-white rounded-3xl w-full max-w-4xl p-6 shadow-2xl border border-slate-100 max-h-[90vh] overflow-y-auto space-y-6 text-right">
            ...
            {/* Modal Header */}
            <div className="flex justify-between items-center pb-3 border-b">
              <h3 className="text-base font-black text-[#1C5B6B] flex items-center gap-1.5">
                <FileText className="w-5 h-5 text-[#229FA0]" />
              ...
              {activePortal === 'employee' ? (
                <>
                  <div className="space-y-1">
                    ...
                    <span className="text-xs font-black text-[#1C5B6B]">{selectedViewDoc.employeeName}</span>
                  </div>
                  <div className="space-y-1">
            ...
            <div className="space-y-3">
              ...
              {selectedViewDoc.docFile ? (
                <div className="border border-slate-200 rounded-2xl overflow-hidden bg-slate-100 flex flex-col items-center justify-center p-4 min-h-[300px] shadow-inner relative group">
                  {selectedViewDoc.docFile.startsWith('data:image/') ? (
                    ...
                    <div className="p-8 text-center bg-white rounded-2xl border max-w-sm">
                      <Paperclip className="w-12 h-12 text-[#1C5B6B] mx-auto mb-2 animate-bounce" />
                  ...
                  <div className="mt-4 flex gap-2 justify-center w-full">
                    <label className="text-[11px] bg-blue-50 text-blue-700 hover:bg-[#1C5B6B] hover:text-white px-3 py-1.5 rounded-xl border border-blue-200 cursor-pointer transition-all font-bold flex items-center gap-1">
                ...
                <div className="border-2 border-dashed border-slate-300 rounded-3xl p-8 text-center bg-slate-50 flex flex-col items-center justify-center gap-2">
                  ...
                  <label className="mt-2 text-xs bg-[#1C5B6B] hover:bg-blue-800 text-white font-black px-4 py-2 rounded-xl shadow cursor-pointer transition-all flex items-center gap-1.5">
              ...
              {selectedViewDoc.docUrl && (
                <div className="bg-slate-50 p-3 rounded-2xl border flex items-center justify-between text-xs">
                  <div className="text-right">
                    ...
                    <a href={selectedViewDoc.docUrl} target="_blank" rel="noreferrer" className="text-[#1C5B6B] underline font-mono break-all">{selectedViewDoc.docUrl}</a>
                  </div>
                  <a 
                    href={selectedViewDoc.docUrl} 
                    target="_blank" 
                    rel="noreferrer"
                    className="p-2 bg-[#1C5B6B]/10 text-[#1C5B6B] hover:bg-[#1C5B6B] hover:text-white rounded-xl transition-all font-bold text-[10px]"
                  >
