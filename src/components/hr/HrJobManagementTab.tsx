      ...
      <div className="flex justify-between items-center pb-2 border-b border-slate-100">
        <div>
          <h4 className="text-sm font-black text-[#1C5B6B] flex items-center gap-2">
            <Briefcase className="w-4 h-4 text-[#229FA0]" />
        ...
        <button 
          ...
          className="px-3 py-1.5 bg-[#1C5B6B] text-white text-[11px] font-black rounded-xl flex items-center gap-1 hover:bg-[#1C5B6B]/95"
        >
          ...
          <div key={role.id} className="p-5 bg-slate-50/80 rounded-2xl border border-slate-100/50 space-y-3 relative hover:bg-slate-100/20 transition-all">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 border-b border-slate-200/50 pb-2">
              <div>
                ...
                <span className="text-[9px] bg-[#229FA0]/20 text-[#1C5B6B] font-mono px-2 py-0.5 rounded font-black uppercase">Grade {role.gradeScale} / المجموع الدرجة {role.gradeScale}</span>
              ...
              <div className="text-right">
                ...
                <p className="text-xs font-black text-[#1C5B6B] font-mono">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-2">
              <span className="text-[9px] uppercase font-bold text-[#1C5B6B] flex items-center gap-1 shrink-0">
