      ...
      <input
        ...
        className={`w-16 px-1 py-1 text-center bg-stone-50 border rounded-lg font-bold transition-all ${
          saved
            ...
            : "border-slate-200 text-slate-700 focus:border-[#1C5B6B] focus:bg-white focus:ring-1 focus:ring-[#1C5B6B]"
        }`}
        title={
          lang === "ar"
      ...
      <button
        ...
        className={`p-1 rounded-lg border transition ${
          saved
            ...
            : "bg-white hover:bg-slate-50 border-slate-200 text-slate-500 hover:text-[#1C5B6B] cursor-pointer"
        }`}
        ...
        <div className="absolute z-10 w-full mt-1 bg-white border border-slate-200 rounded-xl shadow-xl max-h-60 flex flex-col">
          <div className="p-2 border-b border-slate-100 sticky top-0 bg-white rounded-t-xl">
            <input
              type="text"
              autoFocus
              className="w-full text-xs px-2 py-1.5 bg-slate-50 border border-slate-200 rounded focus:outline-none focus:border-[#1C5B6B]"
          ...
          <div className="overflow-y-auto">
            {filteredOptions.length === 0 ? (
              ...
              filteredOptions.map((opt) => (
                <div
                  key={opt.id}
                  className={`px-3 py-2 cursor-pointer hover:bg-sky-50 ${value === opt.id ? "bg-sky-100 text-[#1C5B6B] font-bold" : "text-slate-700"}`}
                  onClick={() => {
                    onChange(opt.id);
                    setIsOpen(false);
                    setSearch("");
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-bold text-slate-800 text-lg flex items-center gap-2">
            <FileText className="w-5 h-5 text-[#1C5B6B]" />
                ...
                <div className="flex-1 min-w-0 mr-2">
                  ...
                  att.id !== "legacy-2" ? (
                    <input
                      ...
                      className="w-full text-xs px-2 py-1 border border-[#1C5B6B] rounded"
                      autoFocus
                    />
                  ) : (
                  ...
                  att.id !== "legacy-2" ? (
                    ...
                    <>
                      ...
                      <a
                        href={att.fileData}
                        download={att.name}
                        className="px-2 py-1 bg-sky-50 text-[#1C5B6B] rounded text-xs font-bold hover:bg-sky-100"
                      >
          ...
          <div className="flex gap-2 items-start">
            <div className="flex-1 space-y-2">
              ...
              <input
                ...
                className="w-full text-xs file:mr-2 file:py-1 file:px-3 file:rounded-xl file:border-0 file:bg-sky-50 file:text-[#1C5B6B] file:font-bold"
              />
            </div>
            <button
              onClick={handleUpload}
              disabled={!newFile || isUpdating}
              className="px-4 py-2 bg-[#1C5B6B] hover:bg-sky-700 disabled:opacity-50 text-white rounded-xl text-xs font-bold shrink-0 min-w-[70px] flex items-center justify-center"
            >
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 border-b border-slate-100 gap-4">
        <div>
          <h4 className="text-sm font-black text-[#1C5B6B] flex items-center gap-2">
            <Calendar className="w-5 h-5 text-[#229FA0]" />
            {lang === "ar"
          ...
          <form onSubmit={handleHrSubmitLeave} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-[#1C5B6B] font-mono"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-[10px] px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl file:mr-2 file:py-1 file:px-2 file:rounded-lg file:border-0 file:bg-[#1C5B6B] file:text-white file:font-bold hover:file:bg-sky-700"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
              ...
              <div className="md:col-span-8 space-y-2">
                {startDate && endDate && (
                  <div className="bg-sky-50 text-[#1C5B6B] p-2 rounded-xl text-center font-bold text-xs inline-block mb-2 px-3">
              ...
              <div className="md:col-span-4 space-y-2">
                ...
                <button
                  ...
                  className="w-full py-3 bg-[#1C5B6B] hover:bg-sky-700 disabled:bg-slate-400 disabled:cursor-not-allowed text-white rounded-xl text-xs font-bold shadow-lg shadow-[#1C5B6B]/10 transition flex items-center justify-center gap-1"
                >
                  {isSubmitting ? (
                    <span className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></span>
                  ) : (
      ...
      <div className="space-y-6">
        ...
        <div className="glass-panel p-5 bg-white rounded-3xl border border-slate-100/85">
                ...
                {requests.map((req) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-2">
                      <span className="px-2 py-1 bg-sky-50 text-[#1C5B6B] rounded-lg text-[10px] font-bold">
                        {lang === "ar" ? req.type_ar : req.type_en}
                      </span>
                    </td>
                    <td className="py-3 px-2 text-center font-mono text-[#1C5B6B] font-semibold">
                      {req.startDate}
                    </td>
                    <td className="py-3 px-2 text-center font-mono text-[#1C5B6B] font-semibold">
                      {req.endDate}
          ...
          {/* Leave Balances Grid */}
          <div className="glass-panel p-5 bg-white rounded-3xl border border-slate-100/85">
            <h5 className="font-extrabold text-sm text-[#1C5B6B] mb-4">
              🌴{" "}
              {lang === "ar"
            ...
            <div className="flex justify-between items-center p-3 border-b border-slate-100">
              ...
              <div className="flex gap-2 items-center">
                <a
                  href={previewFile}
                  download="attachment"
                  className="text-xs px-3 py-1.5 bg-[#1C5B6B] text-white rounded-xl font-bold hover:bg-sky-700"
                >
                  {lang === "ar" ? "تحميل" : "Download"}
                </a>
                <button
              ...
              previewFile.match(/\.(jpeg|jpg|gif|png)$/i) != null ? (
                ...
                <div className="text-center text-slate-500">
                  ...
                  <a
                    ...
                    className="text-[#1C5B6B] underline font-bold px-4 py-2 block"
                  >
