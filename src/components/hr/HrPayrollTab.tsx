    ...
    const rowsHtml = employees.map(emp => {
      ...
      return `
        <tr>
          ...
          <td style="border: 1px solid #ddd; padding: 10px; font-weight: bold; color: #1C5B6B;">${data.status}</td>
        </tr>
      `;
    }).join('');
    ...
    const html = `
      ...
      <head>
        ...
        <style>
          ...
          .hdr { text-align: center; border-bottom: 2px solid #1C5B6B; padding-bottom: 15px; margin-bottom: 25px; }
          .hdr h1 { margin: 0 0 5px; color: #1C5B6B; font-size: 20px; }
          .tbl { width: 100%; border-collapse: collapse; margin-top: 20px; font-size: 11px; }
          .tbl th { background: #1C5B6B; color: white; border: 1px solid #ddd; padding: 10px; text-align: right; }
          .tbl td { text-align: right; }
          .sum-card { margin-top: 30px; border: 2px solid #1C5B6B; padding: 15px; border-radius: 8px; background: #f7fcff; font-size: 12px; }
    ...
    const printHtml = `
      ...
      <head>
        ...
        <style>
          ...
          .fin-table th { background: #1C5B6B; padding: 10px; font-size: 13px; color: white; border: 1px solid #1C5B6B; }
          .fin-table td { padding: 11px; border: 1px solid #ddd; text-align: center; font-size: 13px; font-weight: bold; }
          .net-box { margin-top: 35px; border: 2px solid #229FA0; background: #f0faff; padding: 15px; text-align: center; border-radius: 8px; }
          .net-box h2 { margin: 0 0 5px; color: #1C5B6B; font-size: 18px; }
      ...
      <body>
        <div style="max-width: 800px; margin: 0 auto; display: flex; flex-direction: column; min-height: 90vh;">
          ...
          <div style="flex-grow: 1;">
            ...
            <h3 style="color: #1C5B6B; border-bottom: 1px solid #ddd; padding-bottom: 5px;">📊 تفاصيل المستحقات والاستقطاعات المالية:</h3>
            ...
            <div class="footer-claims">
              ...
              <button class="no-print" style="margin-top: 15px; padding: 8px 18px; background: #1C5B6B; color:white; border:none; border-radius: 4px; cursor:pointer;" onclick="window.print()">طباعة الآن</button>
            </div>
          </div>
          ${sharedPrintFooter}
        </div>
  ...
  return (
    <div id="hr-payroll-system-module" className="space-y-6 text-right">
          ...
          <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-center gap-4 text-right" dir="rtl">
            ...
            <div className="flex items-center gap-2">
              ...
              <select 
                ...
                className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs font-black text-slate-700 outline-none focus:border-[#1C5B6B]"
              >
                {gregoryMonths.map(m => (
      ...
      {activeHRSubTab === 'payroll_employees' && (
        <div className="bg-gradient-to-br from-[#1C5B6B]/10 to-indigo-50/50 rounded-3xl border border-[#1C5B6B]/20 p-6 space-y-4 text-right" dir="rtl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 bg-white p-4 rounded-2xl border border-slate-100">
            ...
            <select
              ...
              className="w-full max-w-md bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-bold text-slate-800 focus:outline-none focus:ring-1 focus:ring-[#1C5B6B] focus:bg-white transition"
            >
              ...
              return (
                <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm space-y-6">
                  ...
                  <div className="flex justify-between items-center border-b pb-4">
                    <div>
                      <span className="text-[10px] bg-blue-50 text-[#1C5B6B] font-black px-2 py-1 rounded-lg">
                        ID: {emp.id}
                      </span>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-4 border-t border-slate-100">
                    <button
                      ...
                      className="w-full sm:w-auto px-6 py-2.5 bg-[#1C5B6B] text-white hover:bg-[#1C5B6B]/95 rounded-2xl text-xs font-black transition flex items-center justify-center gap-1.5 shadow"
                    >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border-b border-slate-100 pb-3">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input 
              ...
              className="w-full pl-4 pr-9 py-2 bg-slate-50 border border-slate-200 rounded-2xl text-xs font-bold font-sans text-slate-800 focus:outline-none focus:ring-1 focus:ring-[#1C5B6B] focus:bg-white transition"
            />
          </div>
        </div>
                ...
                filteredEmployees.map((emp) => {
                  ...
                  return (
                    <tr key={emp.id} className="border-b border-slate-100 hover:bg-slate-50/50 text-slate-600 transition">
                      <td className="py-3 px-3 font-mono font-black text-[#1C5B6B]">{emp.id}</td>
                      ...
                      <td className="py-3 px-3 text-center">
                        <button
                          onClick={() => handleOpenEmpSalary(emp)}
                          className="px-3 py-1.5 bg-[#1C5B6B] hover:bg-sky-600 font-extrabold text-white text-[10px] rounded-xl transition flex items-center gap-1.5 mx-auto"
                        >
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 rounded-3xl border border-slate-100 max-w-2xl w-full max-h-[92vh] flex flex-col justify-between gap-4 text-right overflow-y-auto" dir="rtl">
            ...
            <div className="flex justify-between items-start border-b pb-3">
              ...
              <div className="text-right">
                <h3 className="font-black text-[#1C5B6B] text-base">
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="flex border-b border-slate-100 text-xs gap-4 font-black">
                <button 
                  ...
                  className={`pb-2 border-b-2 px-1 transition ${!showPayslipView ? 'border-[#1C5B6B] text-[#1C5B6B]' : 'border-transparent text-slate-400'}`}
                >
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-5 border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50/60 font-sans space-y-4 text-xs">
                    ...
                    <div className="border-b-2 border-slate-200 pb-2 flex justify-between items-center">
                      <div className="text-right">
                        <h4 className="font-black text-slate-800 text-sm">مجموعة الصفحة التالية للعلامات التجارية</h4>
                    ...
                    <div className="space-y-1.5 pt-1">
                      <h5 className="font-extrabold text-[11px] text-[#1C5B6B]">تفريغ الحركة المالية للشهر الحالي:</h5>
                  ...
                  <div className="flex flex-wrap gap-2 text-xs font-black justify-end pt-2">
                    ...
                    <button 
                      ...
                      className={`px-4 py-2 text-white rounded-xl transition flex items-center gap-1.5 ${
                        sendSuccess ? 'bg-emerald-600' : 'bg-[#1C5B6B] hover:brightness-105'
                      }`}
                    >
                      {sendSuccess ? (
                        <>
            ...
            <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto" dir="rtl">
              <div className="bg-white rounded-3xl max-w-2xl w-full border border-slate-100 shadow-2xl p-6 space-y-4 max-h-[90vh] overflow-y-auto" id="deductions-interactive-modal">
                ...
                <div className="flex justify-between items-center pb-2 border-b">
                  <h4 className="text-sm font-black text-slate-800 flex items-center gap-1.5 text-[#1C5B6B]">
                        ...
                        <div className="bg-slate-50 border border-slate-100 p-4 rounded-2xl text-right space-y-3">
                          <div className="flex justify-between items-center border-b pb-2">
                            <div>
                              ...
                              <p className="font-black text-[#1C5B6B] text-sm mt-0.5">{emp.arabicName} ({emp.id})</p>
                            </div>
                            {!editingDeduction && (
                              <button
                                type="button"
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs bg-white p-3 rounded-xl border border-slate-100">
                            ...
                            <div>
                              ...
                              <p className="font-mono font-extrabold text-[#1C5B6B] mt-0.5">{emp.iqamaId || '---'}</p>
                            </div>
                            <div>
                ...
                {dedFormEmpId && (
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-slate-50/50 border border-slate-100 rounded-2xl space-y-3.5 text-right">
                      ...
                      {dedFormType === 'سلفة' && (
                        <div className="space-y-3">
                          <h6 className="text-xs font-black text-[#1C5B6B]">💰 خيارات وضوابط السداد والتقسيط للسلفة:</h6>
                    ...
                    <div className="space-y-1">
                      <label className="block text-xs font-black text-[#1C5B6B]">✍️ شرح تفصيلي وسبب الخصم (يظهر مباشرة للموظف في حسابه كإشعار رسمي):</label>
                      <textarea 
                        value={dedFormReason}
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className={`px-4 py-2.5 font-black text-xs rounded-xl transition shadow-sm ${
                            isDeductionBlocked 
                              ? 'bg-[#1C5B6B]/20 text-blue-200 border border-[#1C5B6B]/10 cursor-not-allowed select-none opacity-50' 
                              : 'bg-[#1C5B6B] hover:brightness-105 text-white'
                          }`}
                        >
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <select 
                value={selectedMonth}
                onChange={(e) => setSelectedMonth(e.target.value)}
                className="bg-slate-100 border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-black text-[#1C5B6B]"
              >
                {gregoryMonths.map(m => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-white p-4 rounded-2xl border border-slate-100 space-y-2">
                ...
                <div 
                  ...
                  className="border-2 border-dashed border-[#1C5B6B]/20 hover:border-[#1C5B6B]/80 transition p-3 rounded-xl text-center cursor-pointer bg-[#1C5B6B]/5"
                >
                  <span className="text-[10px] font-black text-[#1C5B6B] block">📤 اضغط هنا لتحديد الملف أو إسقاطه</span>
