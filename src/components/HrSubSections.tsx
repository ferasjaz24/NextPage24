      ...
      {!isExternalNav && (
        <aside className="col-span-12 lg:col-span-4 bg-white/70 backdrop-blur-md border border-slate-100 rounded-3xl p-6 space-y-3 max-h-[85vh] overflow-y-auto">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <h4 className="font-extrabold text-[#1C5B6B] text-sm flex items-center gap-2">
              <span>⚙️</span>
              {lang === 'ar' ? 'القائمة الكاملة لشؤون الموظفين' : 'HR Affairs Modules Matrix'}
            </h4>
            <span className="text-[10px] bg-[#229FA0]/20 text-[#1C5B6B] font-mono px-2 py-0.5 rounded font-extrabold">
                ...
                <div key={grp.id} className="border-b border-slate-50 pb-1">
                  <button
                    ...
                    className={`w-full flex items-center justify-between p-2.5 rounded-xl text-xs font-black transition-all ${
                      isExpanded ? 'bg-[#1C5B6B]/5 text-[#1C5B6B]' : 'text-slate-700 hover:bg-slate-50'
                    }`}
                  >
                    <div className="flex items-center gap-2">
                      <Icon className="w-4 h-4 text-[#1C5B6B]" />
                      ...
                      {grp.subs.map(sub => (
                        <button
                          ...
                          className={`w-full text-left p-2 rounded-lg text-[11px] font-bold transition-all text-right ${
                            ...
                            ? 'bg-[#229FA0] text-white shadow-sm' 
      ...
      <section className={`${isExternalNav ? 'col-span-12' : 'col-span-12 lg:col-span-8'} space-y-6`}>
                ...
                {localEmployees.filter(e => e.department === 'عمال المصنع').map(emp => (
                  ...
                  >
                    ...
                    <div className="text-right space-y-1">
                      <div className="font-extrabold text-[#1C5B6B] text-xs">
                      ...
                      <div className="text-[9px] text-[#1C5B6B] font-mono bg-blue-50 px-1.5 py-0.5 rounded inline-block">
                        {emp.id}
                      </div>
                    </div>
                  </div>
        ...
        {activeHRSubTab === 'employees_add' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-4">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'إضافة وتعيين الموظفين الجدد' : 'New Personnel Strategic Sourcing'}</h3>
            ...
            <div className="flex gap-2 text-xs">
              <button 
                ...
                className="px-4 py-2 bg-[#1C5B6B] text-white rounded-xl font-bold font-mono"
              >
          ...
          const handlePrintReceipt = (emp: Employee) => {
            ...
            const printContent = `
              <div style="text-align: center; margin-bottom: 25px;">
                <h1 style="color: #1C5B6B; margin: 0; font-size: 24px;">شركة الصفحة التالية للخدمات التقنية</h1>
                <p style="color: #555; margin: 5px 0 0 0; font-size: 12px; font-weight: bold;">Al Waleed Brands Co. ERP Payroll Document</p>
                <div style="height: 3px; bg-color: #1C5B6B; background: #1C5B6B; margin-top: 15px;"></div>
              </div>
              ...
              <div style="border: 2px dashed #1C5B6B; font-size: 18px; font-weight: bold; padding: 15px; text-align: center; margin-top: 25px; background: #f0f9ff; text-align: right; display: flex; justify-content: space-between; align-items: center;">
                <span style="color: #1C5B6B;">صافي الراتب المستحق والصرف البنكي:</span>
                <span style="font-family: monospace; font-size: 22px; color: #1C5B6B;"><img src="https://www.sama.gov.sa/ar-sa/Currency/Documents/Saudi_Riyal_Symbol-1.png" style="height: 14px; width: auto; display: inline-block; vertical-align: middle; margin: 0 4px;" referrerPolicy="no-referrer" /> ${(net || 0).toLocaleString('en-US')}</span>
              </div>
              ...
              <div style="margin-top: 40px; display: flex; justify-content: space-between; font-size: 11px; color: #64748b;">
                ...
                <div>ختم شركة الصفحة التالية للخدمات التقنية الرسمي للعلامات التجارية [الاعتماد البنكي المرن]</div>
              </div>
            `;
                  ...
                  <body>
                    <div style="max-width: 800px; margin: 0 auto; display: flex; flex-direction: column; min-height: 90vh;">
                      ...
                      <div class="payslip-box" style="flex-grow: 1;">
                        <h2 style="color: #1C5B6B; font-size: 20px; text-align: center; margin-bottom: 5px;">كشف راتب الشهر المعتمد</h2>
                        ${printContent}
                      </div>
                      ${sharedPrintFooter}
                    </div>
          ...
          return (
            <div className="space-y-6" dir="rtl">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div className="bg-gradient-to-br from-[#1C5B6B]/5 to-white p-4 rounded-2xl border border-[#1C5B6B]/20 text-right space-y-1">
                  <span className="text-[10px] text-slate-500 font-bold block">إجمالي الرواتب شاملة البدلات</span>
                  <p className="text-xl font-mono font-black text-[#1C5B6B]"><SaudiRiyal /> {(grandTotalSalaries || 0).toLocaleString('en-US')}</p>
                  <span className="text-[9px] text-[#1C5B6B] font-semibold block">مغطي بمسير WPS البنكي 💸</span>
                </div>
              ...
              <div className="glass-panel p-5 rounded-3xl bg-white border border-slate-100 space-y-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <h3 className="text-sm font-black text-[#1C5B6B]">🔍 محرك بحث كشوفات ومسيرات الموظفين الفردية</h3>
                  ...
                  <div className="relative max-w-xs w-full">
                    ...
                    <input 
                      ...
                      className="w-full text-xs p-2.5 pr-9 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1C5B6B]/30 bg-slate-50 font-bold"
                    />
                  </div>
                </div>
                ...
                {payrollSearchQuery && (
                  <div className="border border-slate-100 rounded-2xl overflow-hidden bg-slate-50/50">
                    <table className="w-full text-right text-xs">
                      <thead>
                        <tr className="bg-[#1C5B6B]/5 text-[#1C5B6B] font-bold text-[10px] border-b border-slate-150">
                      ...
                      <tbody>
                        {filteredPayroll.length === 0 ? (
                          ...
                          filteredPayroll.map(emp => (
                            <tr key={emp.id} className="border-b border-slate-100 bg-white hover:bg-[#1C5B6B]/5">
                              ...
                              <td className="p-2 text-center">
                                <button 
                                  ...
                                  className="px-3.5 py-1.5 bg-[#1C5B6B] text-white text-[10px] font-black rounded-lg hover:bg-sky-600 transition"
                                >
                                  📄 عرض كشف مسير الراتب
                                </button>
                              </td>
              ...
              <div className="glass-panel p-6 rounded-3xl bg-white border border-slate-100 space-y-4">
                <div className="flex justify-between items-center pb-2 border-b border-slate-100">
                  <h4 className="text-xs font-black text-[#1C5B6B] block">🇸🇦 مسير WPS والرواتب الكلية المعتمد للشهر الجاري</h4>
                  ...
                  <table className="w-full text-right text-[11px] border-collapse min-w-[950px]">
                    <thead>
                      <tr className="border-b border-slate-200 bg-slate-50 text-[10px] uppercase font-mono text-slate-400">
                        ...
                        <th className="p-2 text-right text-[#1C5B6B]">صافي المستحق</th>
                          ...
                          <tr key={emp.id} className="border-b border-slate-50 hover:bg-slate-50/70 transition">
                            ...
                            <td className="p-2">
                              <input 
                                ...
                                className="w-16 p-1 border rounded text-xs text-center font-mono focus:ring-1 focus:ring-[#1C5B6B]"
                              />
                            </td>
                            ...
                            {/* NET SALARY RESULT */}
                            <td className="p-2 font-mono font-black text-[#1C5B6B] text-xs">
                            ...
                            <td className="p-2 flex gap-1 justify-center">
                              <button 
                                ...
                                className="p-1 px-2 bg-slate-100 text-slate-700 hover:bg-[#1C5B6B] hover:text-white rounded font-bold text-[10px] transition"
                              >
                                📄 كشف الراتب
                              </button>
                              <button 
                                ...
                                className={`p-1 px-2 text-white font-bold text-[10px] rounded transition ${isSendingPayslip === emp.id ? 'bg-slate-300' : 'bg-[#1C5B6B] hover:bg-emerald-600'}`}
                              >
                  ...
                  <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white p-6 rounded-3xl border border-slate-100 max-w-xl w-full flex flex-col justify-between gap-4 text-right shadow-2xl" dir="rtl">
                      <div className="flex justify-between items-center border-b pb-3">
                        <div>
                          <h3 className="font-extrabold text-[#1C5B6B] text-base">📄 مستند كشف الراتب وشؤون التصفية ومسيرات WPS</h3>
                      ...
                      <div id="print-payslip-canvas" className="p-5 border border-slate-200 rounded-2xl bg-slate-50 space-y-4 max-h-[50vh] overflow-y-auto">
                        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                          <h4 style={{ color: '#1C5B6B', margin: 0, fontSize: '18px', fontWeight: 'bold' }}>شركة الصفحة التالية للخدمات التقنية</h4>
                        ...
                        <div className="p-3 bg-[#1C5B6B]/10 border border-all border-[#1C5B6B]/20 rounded-xl flex justify-between items-center font-bold text-xs">
                          <span className="text-[#1C5B6B]">إجمالي صافي الراتب المستلم للبنك:</span>
                          <span className="text-[#1C5B6B] font-mono text-sm"><SaudiRiyal /> {(net || 0).toLocaleString('en-US')}</span>
                        </div>
                      </div>
        ...
        {activeHRSubTab === 'loans_calculator' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-6">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'طلبات السلف وجدولة الأقساط الشهرية' : 'Personal Loans & Monthly Cash Installment Scheduler'}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-6 rounded-2xl border border-slate-100">
              ...
              <div className="p-4 bg-white border border-slate-150 rounded-2xl flex flex-col justify-between text-xs text-slate-700">
                <div>
                  ...
                  <p className="text-3xl font-black text-[#1C5B6B] font-mono mt-1"><SaudiRiyal /> {(loanAmount / (loanMonths || 1)).toFixed(2)}</p>
                </div>
        ...
        {activeHRSubTab === 'custody_ledger' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-4">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'سجل العهد وتسليم اللوازم والأصول للعمال' : 'Workers Custody allocation, handovers & return notes'}</h3>
            ...
            <div className="bg-slate-50/85 p-5 rounded-2xl border border-slate-150 space-y-3 dark:border-slate-700/40">
              <div className="flex items-center gap-2 border-b border-slate-200/50 pb-2">
                ...
                <h4 className="font-extrabold text-[#1C5B6B] text-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3 items-end text-xs text-right" dir="rtl">
                <div>
                  ...
                  <select
                    ...
                    className="w-full text-xs p-2.5 bg-white border border-slate-250 rounded-xl font-bold focus:outline-none focus:border-[#1C5B6B]"
                  >
                ...
                <div className="flex gap-2 md:col-span-2">
                  <button
                    ...
                    className="flex-1 py-2.5 px-4 bg-[#1C5B6B] hover:bg-[#1C5B6B]/95 text-white font-black text-xs rounded-xl transition-all shadow-sm flex items-center justify-center gap-1.5 cursor-pointer"
                  >
                  ...
                  <tr key={emp.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="p-2 font-mono">
                      {emp.custody?.laptop ? (
                        <div className="flex items-center gap-1.5">
                          <span className="text-[#1C5B6B] font-semibold">{emp.custody.laptop}</span>
                          <button 
                    ...
                    <td className="p-2 font-mono">
                      {emp.custody?.vehicles ? (
                        <div className="flex items-center gap-1.5">
                          <span className="text-[#229FA0] font-semibold">{emp.custody.vehicles}</span>
                          <button 
        ...
        {activeHRSubTab === 'perf_reviews' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-4">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'خطط التقييم السنوية ومؤشرات الأداء KPI' : 'Annual appraisals plan, KPIs metrics & Goals scorecard'}</h3>
        ...
        {activeHRSubTab === 'promo_records' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-4">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'سجل ترقية المسميات والزيادات المالية' : 'Promotions, spot bonuses & career upgrades log'}</h3>
            ...
            <button onClick={() => alert('Feature simulation - New Promotion letter logged')} className="px-4 py-2 bg-[#1C5B6B] text-white text-xs font-black rounded-xl shadow-md">{lang === 'ar' ? 'رفع درجة وعلاوة لموظف جديد' : 'Log New Upgraded Staff'}</button>
          </div>
        )}
        ...
        {activeHRSubTab === 'med_insurance' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-4">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'التأمين الطبي والتعاقدات العائلية' : 'Bupa & Tawuniya Medical Insurance Directory'}</h3>
            <table className="w-full text-xs text-slate-700">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50 text-[10px] uppercase">
        ...
        {activeHRSubTab === 'gov_documents' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-4">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'التأمينات الاجتماعية وصلاحيات رخص العمل والإقامات' : 'Ministry of Labor Residency (Iqama), Passport & GOSI tracking'}</h3>
            <table className="w-full text-xs text-slate-700">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50 text-[10px] uppercase">
                  <th className="p-2 text-right">{lang === 'ar' ? 'الموظف' : 'Staff'}</th>
              ...
              <tbody>
                {localEmployees.map(emp => (
                  <tr key={emp.id} className="border-b border-slate-50">
                    ...
                    <td className="p-2 text-[#229FA0] font-mono">Active (Qiwa)</td>
        ...
        {activeHRSubTab === 'eos_calculator' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-6">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'مكافأة نهاية الخدمة بالخدمة الذاتية (حسب قانون العمل السعودي)' : 'Saudi Labor Law End of Service (EOS) Gratuity Calculator'}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-6 rounded-2xl border border-slate-100">
              ...
              <div className="p-5 bg-[#1C5B6B] text-white rounded-2xl flex flex-col justify-between text-xs">
                <div>
        ...
        {activeHRSubTab === 'clearance_matrix' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-4">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'طلبات مسارات التصفية الفنية والأمنية' : 'Personnel exit & clearance workflows'}</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
        ...
        {activeHRSubTab === 'hr_library_letters' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-6">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'توليد وطباعة خطابات الموارد البشرية الفورية' : 'HR Letters & Corporate Certificates Printer'}</h3>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 space-y-4 text-xs">
              ...
              {selectedLetterEmp && (
                <div className="p-8 bg-white border-2 border-dashed border-slate-200 rounded-2xl space-y-4 uppercase text-[11px] leading-relaxed font-mono">
                  <div className="text-center font-extrabold text-sm border-b pb-3 text-[#1C5B6B]">
        ...
        {activeHRSubTab === 'approvals_hub' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-4">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'مركز الموافقات الفورية الموحد للمدير العام' : 'Unified Executive Approvals Hub'}</h3>
        ...
        {activeHRSubTab === 'strategic_reports' && (
          <div className="glass-panel p-6 rounded-3xl bg-white/80 border border-slate-100 space-y-4">
            <h3 className="text-base font-black text-[#1C5B6B]">{lang === 'ar' ? 'التقارير والمؤشرات الإستراتيجية للأرباح' : 'Executive HR Analytics & WPS Auditing Reports'}</h3>
            <div className="p-4 bg-slate-50 rounded-xl space-y-2 text-xs">
              ...
              <p>📊 {lang === 'ar' ? 'نسبة تسوية العهد المنتهية: ' : 'Asset Return Settlement Rate: '} <strong className="text-[#229FA0]">100% compliant</strong></p>
            </div>
          </div>
        )}
