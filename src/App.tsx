  ...
  return (
    ...
    >
      ...
      {(isNavigating || activeRequests > 0) && (
        <div className="fixed top-0 left-0 right-0 h-[4px] bg-gradient-to-r from-sky-400 via-sky-500 to-[#1C5B6B] z-50 overflow-hidden" style={{ backgroundSize: '200% 200%' }}>
      ...
      >
        ...
        <div id="brand-identity-group" className="flex items-center gap-4">
          <img
            src="https://i.postimg.cc/ZnkfhYYg/black-logo-nextpage-8.png" referrerPolicy="no-referrer" alt="NextPage Logo" className="w-48 h-20 object-contain"
          />
          <div>
            <h1
              id="brand-main-title"
              className="text-xl font-black text-[#1C5B6B] tracking-wider font-sans"
            >
              {lang === "ar" ? "NextPage Co" : "NextPage Co"}
            </h1>
            <p
              id="brand-subtitle"
              className="text-[10px] text-[#229FA0] font-bold tracking-widest uppercase"
            >
        ...
        >
          ...
          <div className="flex items-center gap-2 relative">
            <button
              ...
              className="p-2.5 rounded-xl bg-slate-200/60 text-slate-600 hover:bg-[#1C5B6B] hover:text-white transition-colors flex items-center gap-2"
              title={lang === 'ar' ? 'تحديث البيانات' : 'Refresh Data'}
            >
              <RefreshCw className={`w-5 h-5 ${(activeRequests > 0 || isNavigating) ? "animate-spin text-[#1C5B6B] hover:text-white" : ""}`} />
              {(activeRequests > 0 || isNavigating) && (
                <span className="hidden lg:inline text-[10px] font-extrabold text-[#1C5B6B] animate-pulse">
            ...
            >
              <button
                id="lang-btn-ar"
                onClick={() => setLang("ar")}
                className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${lang === "ar" ? "bg-[#1C5B6B] text-white shadow-md" : "text-slate-600 hover:text-[#1C5B6B]"}`}
              >
                العربية
              </button>
              <button
                id="lang-btn-en"
                onClick={() => setLang("en")}
                className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${lang === "en" ? "bg-[#1C5B6B] text-white shadow-md" : "text-slate-600 hover:text-[#1C5B6B]"}`}
              >
                EN
              </button>
            </div>
          ...
          {user && (
            ...
            >
              <div className="text-right">
                ...
                <p className="text-[10px] text-[#229FA0] font-bold uppercase">
                  {lang === "ar" ? user.role : user.role}
                </p>
              </div>
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#1C5B6B] to-[#229FA0] flex items-center justify-center text-white font-bold text-lg shadow-inner">
          ...
          >
            ...
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <p className="text-xs text-cyan-400 font-bold tracking-widest uppercase mt-1">
                {lang === "ar"
                  ? "التحقق الثنائي لشركة الصفحة التالية للخدمات التقنية"
            ...
            <form onSubmit={handleRegularLogin} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-5 py-3.5 bg-slate-900/80 border border-slate-700 rounded-2xl text-white text-sm font-mono placeholder-slate-500 focus:outline-none focus:border-[#229FA0] focus:ring-1 focus:ring-[#229FA0] transition-all"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-5 py-3.5 bg-slate-900/80 border border-slate-700 rounded-2xl text-white text-sm placeholder-slate-500 focus:outline-none focus:border-[#1C5B6B] focus:ring-1 focus:ring-[#1C5B6B] transition-all"
                  required
                />
              </div>
              ...
              <button
                id="btn-login-submit"
                type="submit"
                className="w-full py-4 bg-gradient-to-r from-[#1C5B6B] to-[#229FA0] text-white font-bold rounded-2xl text-sm shadow-xl hover:shadow-[#229FA0]/20 transition-all active:scale-[0.98] neon-glow-cyan"
              >
                {lang === "ar"
                  ? "تصديق الدخول للنظام 🡠"
            ...
            >
              <div className="w-full max-w-sm dark-glass-panel border-2 border-cyan-400 p-8 rounded-3xl relative">
                <div className="text-center mb-6">
                  <span className="inline-block p-3 bg-[#1C5B6B]/20 text-[#229FA0] rounded-2xl mb-2">
                ...
                <form onSubmit={handleF24Login} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 text-white font-mono text-sm focus:outline-none focus:border-[#229FA0]"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="••••••••••••••••"
                      className="w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 text-white font-mono text-sm focus:outline-none focus:border-[#1C5B6B]"
                      required
                    />
                  </div>
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <button
                      id="f24-btn-submit"
                      type="submit"
                      className="flex-1 py-3 bg-gradient-to-r from-cyan-500 to-[#1C5B6B] text-white rounded-xl text-xs font-bold shadow-lg"
                    >
          ...
          >
            ...
            <div className="glass-panel rounded-3xl p-6 flex flex-col gap-2 relative overflow-hidden bg-white/70">
              <div className="flex items-center justify-between mb-2">
                <p className="text-[10px] font-bold text-[#1C5B6B] tracking-widest uppercase">
                  {lang === "ar"
                ...
                <button
                  ...
                  className="p-1 rounded-md text-slate-400 hover:text-[#1C5B6B] hover:bg-blue-50 transition-colors"
              ...
              {user && (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition-all ${activeTab === "dashboard" ? "bg-[#1C5B6B] text-white shadow-lg shadow-[#1C5B6B]/15 neon-glow-blue" : "text-slate-600 hover:bg-white/90 hover:text-[#1C5B6B]"}`}
                >
              ...
              {canAccessModule(user, 'hr') && (
                ...
                >
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-4 rounded-2xl text-[14px] font-extrabold transition-all duration-300 ${activeTab === "hr" ? "bg-[#1C5B6B] text-white shadow-xl shadow-[#1C5B6B]/20" : "text-slate-600 hover:bg-slate-50 hover:text-[#1C5B6B]"}`}
                  >
                  ...
                  {isHrDropdownOpen && (
                    <div className="mt-1 mr-2 ml-2 pr-4 text-[13px] flex flex-col gap-2 border-r-2 border-[#1C5B6B]/30 py-2">
                      {hrSubmenus
                        .filter((sub) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-full flex items-center gap-3 py-2.5 px-3.5 rounded-xl text-right font-semibold transition-all duration-200 ${
                                isSubActive
                                  ? "bg-[#1C5B6B] text-white font-extrabold shadow-md shadow-[#1C5B6B]/15 scale-[1.02]"
                                  : "text-slate-600 hover:bg-slate-100 hover:text-[#1C5B6B]"
                              }`}
                            >
              ...
              {canAccessModule(user, 'sales') && (
                ...
                >
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-4 rounded-2xl text-[14px] font-extrabold transition-all duration-300 ${activeTab === "sales" ? "bg-[#1C5B6B] text-white shadow-xl shadow-[#1C5B6B]/20" : "text-slate-600 hover:bg-slate-50 hover:text-[#1C5B6B]"}`}
                  >
                    <div className="flex items-center gap-3">
              ...
              {canAccessModule(user, 'procurement') && (
                ...
                >
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-4 rounded-2xl text-[14px] font-extrabold transition-all duration-300 ${activeTab === "warehouse" ? "bg-[#1C5B6B] text-white shadow-xl shadow-[#1C5B6B]/20" : "text-slate-600 hover:bg-slate-50 hover:text-[#1C5B6B]"}`}
                  >
                    <div className="flex items-center gap-3">
              ...
              {canAccessModule(user, 'finance') && (
                ...
                >
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-4 rounded-2xl text-[14px] font-extrabold transition-all duration-300 ${activeTab === "finance" ? "bg-[#1C5B6B] text-white shadow-xl shadow-[#1C5B6B]/20" : "text-slate-600 hover:bg-slate-50 hover:text-[#1C5B6B]"}`}
                  >
                    <div className="flex items-center gap-3">
              ...
              {canAccessModule(user, 'production') && (
                ...
                >
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-4 rounded-2xl text-[14px] font-extrabold transition-all duration-300 ${activeTab === "production" ? "bg-[#1C5B6B] text-white shadow-xl shadow-[#1C5B6B]/20" : "text-slate-600 hover:bg-slate-50 hover:text-[#1C5B6B]"}`}
                  >
                    <div className="flex items-center gap-3">
              ...
              {(user.role === "Super Admin" || user.username === "FERAS") && (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition-all ${activeTab === ("super_admin" as any) ? "bg-[#1C5B6B] text-white shadow-lg shadow-[#1C5B6B]/15 neon-glow-blue" : "text-slate-600 hover:bg-white/90 hover:text-[#1C5B6B]"}`}
                >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition-all ${
                  activeTab === "hr" && activeHrSubTab === "ess_dashboard"
                    ? "bg-[#1C5B6B] text-white shadow-lg shadow-[#1C5B6B]/15 neon-glow-blue"
                    : "text-slate-600 hover:bg-white/90 hover:text-[#1C5B6B]"
                }`}
              >
            ...
            {user.role === "Super Admin" && (
              <div
                ...
                className="glass-panel rounded-3xl p-6 border-2 border-[#229FA0]/30 bg-white/70"
              >
                <div className="flex items-center gap-2 text-[#1C5B6B] mb-4">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <p className="text-[11px] font-bold text-[#1C5B6B]">
                      ➕{" "}
                      {lang === "ar"
                    ...
                    <button
                      type="submit"
                      className="w-full py-2 bg-[#1C5B6B] text-white text-xs font-bold rounded-lg shadow-md"
                    >
                      {lang === "ar"
            ...
            {!isCurrentTabAccessible() ? (
              <div className="flex flex-col items-center justify-center min-h-[500px] p-8 bg-white border border-slate-200 rounded-3xl shadow-sm text-center">
                {user && user.role === "Employee" && (!user.permissions?.advanced || Object.keys(user.permissions.advanced).length === 0) ? (
                  <>
                    <div className="p-4 bg-sky-50 text-[#1C5B6B] rounded-full mb-6 animate-pulse">
                    ...
                    <button
                      ...
                      className="px-6 py-3 bg-[#1C5B6B] hover:bg-[#005a96] text-white rounded-xl text-sm font-black transition-all shadow-md flex items-center gap-2"
                    >
              ...
              <div id="navigation-loading-view" className="flex flex-col items-center justify-center min-h-[450px] p-12 bg-white border border-slate-100 rounded-3xl shadow-sm relative overflow-hidden transition-all duration-300">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center">
                  <div className="relative flex items-center justify-center">
                    ...
                    {/* Spin spinner */}
                    <div className="absolute w-16 h-16 rounded-full border-4 border-transparent border-t-[#1C5B6B] border-r-[#229FA0] animate-spin" />
                    {/* Central pulsing circle */}
                    <div className="absolute w-6 h-6 rounded-full bg-[#1C5B6B] animate-ping opacity-75" />
                    <div className="absolute w-5 h-5 rounded-full bg-[#1C5B6B]" />
                  </div>
                                  ...
                                  <div className="flex items-center justify-center gap-2">
                                    ...
                                    {(!isFeras || user?.username?.toUpperCase() === "FERAS" || user?.username?.toUpperCase() === "FERASADMIN") && (
                                      <button
                                        ...
                                        className="px-2.5 py-1.5 bg-[#1C5B6B] hover:bg-sky-700 text-white rounded text-[10px] font-black transition disabled:opacity-50 flex items-center gap-1"
                                      >
                                      ...
                                      {[5, 20, 50, 100].map((size) => (
                                        <button
                                          ...
                                          className={`px-2 py-1 rounded-md text-[10px] font-bold transition-all ${
                                            logPerPage === size
                                              ? "bg-[#1C5B6B] text-white shadow-sm"
                  ...
                  <div className="lg:col-span-3 grid grid-cols-1 xl:grid-cols-3 gap-6 mt-6">
                    ...
                    <div className="glass-panel rounded-3xl p-6 bg-white shadow-xl border border-sky-100 flex flex-col gap-4">
                      ...
                      <button
                        ...
                        className="w-full mt-2 py-2.5 bg-[#1C5B6B] hover:bg-[#005B94] disabled:opacity-50 text-white rounded-xl text-xs font-black transition-all flex items-center justify-center gap-1.5 shadow-md shadow-sky-100"
                      >
                  ...
                  {false && (
                    <>
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/60 p-6 rounded-3xl border border-white/50">
                        <div>
                          <h2 className="text-2xl font-black text-[#1C5B6B]">
                            {lang === "ar"
                        ...
                        <button
                          ...
                          className="px-5 py-3 bg-[#1C5B6B] text-white rounded-2xl text-xs font-bold hover:bg-[#1C5B6B]/90 flex items-center gap-2 shadow-lg"
                        >
                      ...
                      >
                        <div className="flex items-center gap-2 text-slate-600 font-bold text-sm">
                          <Filter className="w-4 h-4 text-[#1C5B6B]" />
                          <span>
                            {lang === "ar"
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                className="w-full text-xs px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-[#1C5B6B] pr-8"
                              />
                        ...
                        <div className="fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-4">
                          <div className="w-full max-w-2xl bg-white rounded-3xl p-8 relative overflow-y-auto max-h-[90vh]">
                            <div className="flex justify-between items-center mb-6">
                              <h3 className="text-lg font-black text-[#1C5B6B]">
                                {editingEmp
                                  ? lang === "ar"
                            ...
                            >
                              ...
                              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-250/60 space-y-3">
                                <p className="font-bold text-xs text-[#1C5B6B]">
                                  📦{" "}
                                  {lang === "ar"
                              ...
                              <div className="flex gap-2 justify-end pt-4">
                                ...
                                <button
                                  type="submit"
                                  className="px-6 py-2 bg-[#1C5B6B] text-white rounded-xl font-bold shadow-md"
                                >
                                  {lang === "ar"
                                    ? "حفظ ملف العامل 💾"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 bg-white/70 backdrop-blur-md p-6 rounded-3xl border border-white/50">
                          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col justify-between">
                            <div>
                              ...
                              <h4 className="text-2xl font-black text-[#1C5B6B] font-mono mt-1">
                          ...
                          <div className="p-4 bg-emerald-50/40 rounded-2xl border border-emerald-100 flex flex-col justify-between">
                            ...
                            <p className="text-[9px] text-[#1C5B6B] font-semibold mt-2">
                              {lang === "ar"
                          ...
                          <div className="p-4 bg-slate-900 text-white rounded-2xl flex flex-col justify-between">
                            ...
                            <div className="flex justify-between items-center text-[9px] text-slate-400 mt-2">
                              ...
                              <span className="font-mono text-[#229FA0]">
                                SAR{" "}
                      ...
                      <div className="glass-panel p-6 rounded-3xl bg-white/70 space-y-4">
                        <div className="flex justify-between items-center">
                          <h3 className="font-black text-sm text-[#1C5B6B] flex items-center gap-2">
                            <span>👋</span>
                            {lang === "ar"
                      ...
                      {showClearanceModal && selectedClearanceEmp && (
                        <div className="fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-4">
                          <div className="w-full max-w-lg bg-white rounded-3xl p-8 relative">
                            <div className="flex justify-between items-center mb-6">
                              <h3 className="text-base font-black text-[#1C5B6B]">
                                {lang === "ar"
                            ...
                            >
                              <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl">
                                ...
                                <p className="text-sm font-black text-[#1C5B6B] mt-0.5">
                              ...
                              <div>
                                ...
                                <textarea
                                  ...
                                  rows={3}
                                  className="w-full px-3 py-2 border rounded-xl focus:outline-none focus:border-[#1C5B6B]"
                                />
                              </div>
                      ...
                      <div id="hr-master-records-wrapper" className="space-y-4">
                        ...
                        <div className="glass-panel p-6 rounded-3xl bg-white/70 overflow-hidden">
                          <div className="flex justify-between items-center mb-4">
                            <h4 className="font-black text-sm text-[#1C5B6B] uppercase tracking-wider">
                              {lang === "ar"
                                ? "قائمة تفصيل الكوادر الفنية والمكتبية"
                                : "Al-Waleed Staff Master Listing"}
                            </h4>
                            <span className="text-xs bg-cyan-100 text-[#1C5B6B] px-3 py-1 rounded-full font-bold">
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <td className="py-2 font-mono p-1">
                                        <p className="font-extrabold text-[#1C5B6B]">
                                      ...
                                      <td className="py-2 text-left">
                                        <div className="flex items-center gap-1 justify-end">
                                          <button
                                            ...
                                            className="p-1 px-1.5 bg-blue-50 text-[#1C5B6B] hover:bg-blue-100 rounded font-bold text-[10px]"
                                          ...
                                          <button
                                            ...
                                            className="p-1.5 text-stone-500 hover:text-[#1C5B6B] hover:bg-slate-100 rounded"
                                            title="Edit details"
                                          >
                                            📝
                                          </button>
            ...
            {activeTab === "hr" && activeHrSubTab === "recruitment" && (
              <div id="content-tab-recruitment" className="space-y-6">
                ...
                <div className="glass-panel rounded-3xl p-6 bg-white/70 space-y-4">
                  <div className="flex items-center gap-3">
                    <span className="p-3 bg-gradient-to-tr from-[#229FA0]/20 to-[#1C5B6B]/20 text-cyan-600 rounded-2xl">
                      <Sparkles className="w-8 h-8 text-amber-500 animate-spin" />
                    </span>
                    <div>
                      <h2 className="text-xl font-black text-[#1C5B6B]">
                        {lang === "ar"
                  ...
                  <div className="p-5 bg-gradient-to-r from-slate-900 to-slate-950 text-white rounded-2xl flex flex-col md:flex-row gap-4 items-center">
                    <div className="flex-1 w-full space-y-1">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-800 text-white border border-slate-700 rounded-xl px-4 py-3 text-sm font-mono focus:outline-none focus:border-[#229FA0]"
                      />
                    </div>
                    <button
                      id="ai-btn-generate"
                      ...
                      disabled={aiLoading}
                      className="w-full md:w-auto px-6 py-4 bg-[#229FA0] hover:bg-[#1C5B6B] text-white font-bold rounded-xl text-xs uppercase tracking-widest transition-all self-end shadow-lg"
                    >
                      {aiLoading
                        ? lang === "ar"
                          ? "جاري تحليل الهياكل..."
                  ...
                  {aiResult && (
                    <div
                      ...
                      className="p-6 bg-[#1C5B6B]/5 rounded-3xl border border-[#1C5B6B]/20 grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in text-xs whitespace-pre-line leading-relaxed"
                    >
                      {/* Career details */}
                      <div className="space-y-4">
                        <div>
                          <p className="text-[10px] uppercase font-bold text-[#1C5B6B]">
                            {lang === "ar"
                              ? "المسمى المخطط له"
                              : "Proposed Title"}
                          </p>
                        ...
                        <div>
                          <p className="text-[10px] uppercase font-bold text-[#1C5B6B] flex items-center gap-1">
                            <span>
                              {lang === "ar"
                        ...
                        <div>
                          ...
                          <div id="career-steps" className="space-y-2">
                            {aiResult.careerPath.map((itm, i) => (
                              ...
                              >
                                <span className="w-5 h-5 rounded-full bg-cyan-100 text-[#1C5B6B] font-mono font-bold flex items-center justify-center text-[10px]">
                                  {i + 1}
                                </span>
                          ...
                          <ul className="space-y-2 text-slate-700">
                            {aiResult.responsibilities.map((itm, i) => (
                              <li key={i} className="flex items-start gap-2">
                                <div className="text-[#229FA0] text-base leading-none">
                                  ✔
                                </div>
                                <span>{itm}</span>
                              </li>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {aiResult.skills.map((itm, i) => (
                              <span
                                key={i}
                                className="px-3 py-1 bg-[#1C5B6B]/10 text-[#1C5B6B] rounded-full text-[10px] font-bold"
                              >
                                {itm}
                              </span>
                            ))}
      ...
      {showWelcomeModal && user && (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 max-w-md w-full p-6 lg:p-8 text-center space-y-5 relative overflow-hidden">
            <div className="absolute top-0 right-0 left-0 h-2 bg-gradient-to-r from-[#1C5B6B] via-indigo-500 to-[#0a2540]"></div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm font-bold text-[#1C5B6B]">
                {lang === "ar" ? "حياك الله في نظام NextPage Co" : "Welcome to NextPage Co System"}
              </p>
            ...
            <button
              ...
              className="w-full py-3 px-6 bg-[#1C5B6B] hover:bg-[#0a2540] text-white font-bold text-sm rounded-2xl shadow-lg transition-all transform active:scale-95"
            >
